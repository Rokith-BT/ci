...
class Floor extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['floor'] = $this->floor_model->floor_list();
         $data['initialData'] = $this->customlib->getpagenation('setup-bed-floor/v2/Setup_Bed_Floor');
        $this->load->view('layout/header');
        $this->load->view('setup/floor', $data);
        $this->load->view('layout/footer');
    }
        public function getbedfloor()
    {
        $data['chargeslist'] = $this->customlib->getpagenation('setup-bed-floor/v2/Setup_Bed_Floor');
