...
class Bedtype extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['bedtype_list'] = $this->bedtype_model->bedtype_list();
         $data['initialData'] = $this->customlib->getpagenation('setup-bed-bed-type/v2/Setup_Bed_Type');
    ...
    {
        $data['chargeslist'] = $this->customlib->getpagenation('setup-bed-bed-type/v2/Setup_Bed_Type');
