...
class Bed extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['initialData'] = $this->customlib->getpagenation('setup-bed-bed/v2/Setup_Bed');
    ...
    {
        $data['chargeslist'] = $this->customlib->getpagenation('setup-bed-bed/v2/Setup_Bed');
    ...
    public function status()
    {
        ...
        $data['initialData'] = $this->customlib->getpagenation('setup-bed-bed-status/v2/Setup_Bed_Status');
        $this->load->view('layout/header');
    ...
    {
        $data['chargeslist'] = $this->customlib->getpagenation('setup-bed-bed-status/v2/Setup_Bed_Status');
        echo json_encode($data['chargeslist']);
    }
