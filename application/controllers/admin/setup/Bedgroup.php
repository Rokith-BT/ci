...
class Bedgroup extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['floor']         = $this->floor_model->floor_list();
         $data['initialData'] = $this->customlib->getpagenation('setup-bed-bed-group/v2/Setup_Bed_Group');
    ...
    {
        $data['chargeslist'] = $this->customlib->getpagenation('setup-bed-bed-group/v2/Setup_Bed_Group');
