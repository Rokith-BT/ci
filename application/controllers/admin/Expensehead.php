...
class Expensehead extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['initialData'] = $this->customlib->getpagenation('setup-finance-expense-head/v2/getAllexpense_head');
    ...
    {
        $data['getexpenselist'] = $this->customlib->getpagenation('setup-finance-expense-head/v2/getAllexpense_head');
        echo json_encode( $data['getexpenselist']);
    }
}
