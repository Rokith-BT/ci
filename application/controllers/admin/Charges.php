...
class Charges extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['initialData'] = $this->customlib->getpagenation('setup-hospital-charge-charges/v2/getAllcharges');
    ...
    {
        $data['chargeslist'] = $this->customlib->getpagenation('setup-hospital-charge-charges/v2/getAllcharges');
    ...
    public function getDatatable()
    {
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $charge_key => $charge_value) {
                ...
                //     $action .= "<a class='btn btn-default btn-xs' data-toggle='tooltip' title='' onclick='delete_recordById(\"" . $api_base_url . "setup-hospital-charge-charges/" . $charge_value->id . "?Hospital_id=" . $data['hospital_id'] . "\")' data-original-title='" . $this->lang->line('delete') . "'> <i class='fa fa-trash'></i></a>";
