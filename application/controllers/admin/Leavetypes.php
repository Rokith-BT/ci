...
class Leavetypes extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['initialData'] = $this->customlib->getpagenation('setup-human-resource-leave-types/v2/SetupHRLeaveTypes');
    ...
    {
        $data['getleavetypelist'] = $this->customlib->getpagenation('setup-human-resource-leave-types/v2/SetupHRLeaveTypes');
        echo json_encode( $data['getleavetypelist']);
    }
}
