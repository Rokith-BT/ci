...
class Finding extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['initialData'] = $this->customlib->getpagenation('setup-findings-finding/v2/getAllfinding');
    ...
    {        
        ...
        $data['findingresult'] = $finding_result;
        $data['initialData'] = $this->customlib->getpagenation('findings_category/v2/getallfinding_category');
        $this->load->view('layout/header', $data);
    ...
    public function getfindinglist()
    {
        $data['getfindinglist'] = $this->customlib->getpagenation('setup-findings-finding/v2/getAllfinding');
        echo json_encode( $data['getfindinglist']);
    }

    public function getfindingcategorylist()
    {
        $data['getfindingcategorylist'] = $this->customlib->getpagenation('findings_category/v2/getallfinding_category');
        echo json_encode( $data['getfindingcategorylist']);
    }
}
