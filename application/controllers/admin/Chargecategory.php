...
class Chargecategory extends Admin_Controller
{
    ...
    public function charges()
    {
        ...
        $data['initialData'] = $this->customlib->getpagenation('setup-hospital-charges-charge-category/v2/getAllcharge_category');
    ...
    {
        $data['chargeslist'] = $this->customlib->getpagenation('setup-hospital-charges-charge-category/v2/getAllcharge_category');
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $charge_key => $charge_value) {
                ...
                if ($charge_value->is_default = "yes") {
                    ...
                    //     $action .= "<a class='btn btn-default btn-xs' data-toggle='tooltip' title='' onclick='delete_recordById(\"" . $api_base_url . "setup-hospital-charges-charge-category/" . $charge_value->id . "?Hospital_id=" . $data['hospital_id'] . "\", \"" . $this->lang->line('delete_message') . "\")' data-original-title='" . $this->lang->line('delete') . "'> <i class='fa fa-trash'></i></a>";
                    // }
