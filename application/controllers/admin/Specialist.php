...
class Specialist extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $data['initialData'] = $this->customlib->getpagenation('setup-human-resource-specialist/v2/SetupHRSpecialist');
    ...
    {
        $data['getspeclist'] = $this->customlib->getpagenation('setup-human-resource-specialist/v2/SetupHRSpecialist');
        echo json_encode( $data['getspeclist']);
    }
}
