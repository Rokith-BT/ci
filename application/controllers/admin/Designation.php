...
class Designation extends Admin_Controller
{
    ...
    public function designation()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $data['initialData'] = $this->customlib->getpagenation('setup-human-resource-designation/v2/SetupHRDesignation');
    ...
    {
        $data['getdesiglist'] = $this->customlib->getpagenation('setup-human-resource-designation/v2/SetupHRDesignation');
        echo json_encode( $data['getdesiglist']);
    }
}
