...
class Incomehead extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['initialData'] = $this->customlib->getpagenation('setup-finance-income-head/v2/getAllincome_head');
    ...
    {
        $data['getincomelist'] = $this->customlib->getpagenation('setup-finance-income-head/v2/getAllincome_head');
        echo json_encode( $data['getincomelist']);
    }
}
