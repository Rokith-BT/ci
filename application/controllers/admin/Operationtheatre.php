...
class Operationtheatre extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['operation_list'] = $this->operationtheatre_model->operation_list();
        $data['initialData'] = $this->customlib->getpagenation('setup-operation-operation/v2/getalloperation');
        $this->load->view('layout/header');
    ...
    {
        $data['getoperationlist'] =$this->customlib->getpagenation('setup-operation-operation/v2/getalloperation');
        echo json_encode($data['getoperationlist']);
    }
    ...
    {     
        ...
        $this->session->set_userdata('sub_menu', 'operation_theatre/index');
        $data['category_list'] = $this->operationtheatre_model->category_list();
        $data['initialData']  = $this->customlib->getpagenation('SetupOperationOperationCategoryController/v2/getalloperationcategory');
        $this->load->view('layout/header');
    ...
    {
        $data['getcategorylist'] = $this->customlib->getpagenation('SetupOperationOperationCategoryController/v2/getalloperationcategory');
        echo json_encode($data['getcategorylist']);
    }
    /* Function is used to add operation name */
