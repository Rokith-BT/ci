...
class Symptoms extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['initialData'] = $this->customlib->getpagenation('setup-symptoms-symptoms-head/v2/Setup_Symptoms_Head');
    ...
    {
        $data['chargeslist'] = $this->customlib->getpagenation('setup-symptoms-symptoms-head/v2/Setup_Symptoms_Head');
    ...
    public function symptomstype()
    {
        ...
        $data['symptomsresult'] = $symptoms_result;
         $data['initialData'] = $this->customlib->getpagenation('setup-symptoms-symptoms-type/v2/Setup_Symptoms_Type');
        $this->load->view('layout/header', $data);
        $this->load->view('admin/symptoms/symptomstypeList', $data);
        $this->load->view('layout/footer', $data);
    }

        public function getsymptomstype()
    {
        $data['chargeslist'] = $this->customlib->getpagenation('setup-symptoms-symptoms-type/v2/Setup_Symptoms_Type');
        echo json_encode( $data['chargeslist']);
    }
