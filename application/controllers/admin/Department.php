...
class Department extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $data['initialData'] = $this->customlib->getpagenation('setup-human-resource-department/v2/SetupHRDepartment');
    ...
    {
        $data['getdepttypelist'] = $this->customlib->getpagenation('setup-human-resource-department/v2/SetupHRDepartment');
        echo json_encode( $data['getdepttypelist']);
    }
}
