...
class Expense extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(array("transaction_model", "Admin_model"));
    ...
    public function index()
    {
        ...
        $data['initialData'] = $this->customlib->getpagenation('finance-expense/v2/getfinanceexpense');
    ...
    public function get_finance_expense()
    {
        $data['get_finance_expense'] = $this->customlib->getpagenation('finance-expense/v2/getfinanceexpense');
        echo json_encode($data['get_finance_expense']);
    }
    ...
    public function getexpenselist()
    {
        ...
        $url = $api_base_url . "finance-expense/v2/get_finance_expense?search=" . urlencode($search) . "&limit=$limit&page=$page";
    ...
    public function getexpancereport()
    {
        $search_type = $this->input->post('search_type');
        $date_from = $this->input->post('date_from');
        $date_to = $this->input->post('date_to');
        ...
        $url = $api_base_url . 'php-expense-report?page=' . $page . '&search=' . $search_value . '&limit=' . $limit;
