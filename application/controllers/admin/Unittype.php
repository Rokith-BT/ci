...
class Unittype extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['initialData'] = $this->customlib->getpagenation('setup-hospital-charges-unit-type/v2/getALLunittype');
    ...
    {
        $data['chargeslist'] = $this->customlib->getpagenation('setup-hospital-charges-unit-type/v2/getALLunittype');
