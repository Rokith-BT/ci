...
$config['appointment_status'] = array(
    'Requested'  => array('id' => 1, 'name' => lang('Requested')),
    'Reserved'  => array('id' => 2, 'name' => lang('Reserved')),
    'Approved'   => array('id' => 3, 'name' => lang('Approved')),
    'Cancelled'  => array('id' => 4, 'name' => lang('Cancelled')),
    'InProcess'  => array('id' => 5, 'name' => lang('In Process')),
    'Completed'  => array('id' => 6, 'name' => lang('Completed')),
);
