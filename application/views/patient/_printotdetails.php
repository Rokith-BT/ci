                                ...
                                <table class="print-table" style="text-align: left; padding-top: 10px;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo !empty($this->customlib->getPatientSessionPrefixByType('operation_theater_reference_no') . $otdetails->id) ? $this->customlib->getPatientSessionPrefixByType('operation_theater_reference_no') . $otdetails->id : '-'; ?></td>
