                ...
                <div class="box box-primary">
                    ...
                    <div class="">
                        <form role="form" id="schsetting_form"
                            action="<?php echo site_url('schsettings/ajax_schedit') ?>" class="" method="post"
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label
                                                class="col-sm-4"><?php echo $this->lang->line('hospital') . " " . $this->lang->line('name'); ?><small
                                                    class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="name" name="sch_name"
                                                    value="<?php echo $settinglist[0]['name'] ?>">
                                                <span class="text-danger"><?php echo form_error('name'); ?></span>
                                                <input type="hidden" name="sch_id"
                                                    value="<?php echo $settinglist[0]['id']; ?>">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label
                                                class="col-sm-4"><?php echo $this->lang->line('hospital') . " " . $this->lang->line('code') ?></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="dise_code"
                                                    name="sch_dise_code"
                                                    value="<?php echo $settinglist[0]['dise_code'] ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="address" name="sch_address"
                                                    value="<?php echo $settinglist[0]['address'] ?>"> <span
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="phone" name="sch_phone"
                                                    value="<?php echo $settinglist[0]['phone'] ?>"><span
                                                    class="text-danger"><?php echo form_error('phone'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label
                                                class="col-sm-4"><?php echo $this->lang->line('hospital')." ".$this->lang->line('logo') ?><small
                                                    class="req"> *</small></label>
                                            <?php
                                            if ($settinglist[0]['image'] == "") {
                                                ?>
                                            <img src="<?php echo base_url("uploads/hospital_content/logo/images.png".img_time()) ?>"
                                                class="" alt="" style="height: 15px;">
                                            <?php
                                            } else {
                                                ?>
                                            <img src="<?php echo base_url('uploads/hospital_content/logo/'.$settinglist[0]['image'].img_time()) ?>"
                                                class="" alt="" style="height: 15px;margin-top: 5px;">
                                            <?php
                                            }
                                            ?>&nbsp;
                                            <?php if ($this->rbac->hasPrivilege('general_setting', 'can_edit')) { ?>
                                            <a href="#schsetting" role="button"
                                                class="btn btn-primary btn-sm upload_logo pull-right"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label
                                                class="col-sm-4"><?php echo $this->lang->line('hospital')." ".$this->lang->line('small')." ".$this->lang->line('logo') ?><small
                                                    class="req"> *</small></label>
                                            <?php
                                            ...
                                            <?php
                                                ...
                                                ?>
                                            <img src="<?php echo base_url('uploads/hospital_content/logo/'.$settinglist[0]['mini_logo'].img_time()) ?>"
                                                class="" alt="">
                                            <?php
                                            }
                                            ?>
                                            ...
                                            <?php if ($this->rbac->hasPrivilege('general_setting', 'can_edit')) { ?>
                                            <a href="#" role="button"
                                                class="btn btn-primary btn-sm upload_minilogo pull-right"
                                                data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i
                                                    class="fa fa-picture-o"></i>
                                                <?php echo $this->lang->line('edit') . " " . $this->lang->line('small') . " " . $this->lang->line('logo'); ?></a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-sm-8">
                                                <select id="language_id" name="sch_lang_id" class="form-control">
                                                    ...
                                                    <option value="<?php echo $language['id']; ?>"
                                                        <?php if($settinglist[0]['lang_id']==$language['id']){ echo 'selected' ; } ?>>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <label class="radio-inline">
                                                    <input type="radio" name="sch_is_rtl" value="disabled"
                                                        <?php if($settinglist[0]['is_rtl']=='disabled'){ echo 'checked' ; } ?>><?php echo $this->lang->line('disabled'); ?>
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="sch_is_rtl" value="enabled"
                                                        <?php if($settinglist[0]['is_rtl']=='enabled'){ echo 'checked' ; } ?>><?php echo $this->lang->line('enabled'); ?>
                                                </label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <h4 class="session-head">
                                            <?php echo $this->lang->line('date') . " " . $this->lang->line('time'); ?>
                                        </h4>
                                    </div>
                                    <!--./col-md-12-->
                                            ...
                                            <div class="col-sm-8">
                                                <select id="date_format" name="sch_date_format" class="form-control">
                                                    ...
                                                    <option value="<?php echo $key ?>"
                                                        <?php if($settinglist[0]['date_format']==$key){ echo 'selected' ; } ?>>
                                                ...
                                                <select id="language_id" name="sch_timezone" class="form-control">
                                                    ...
                                                    <?php
                                                        ...
                                                        foreach ($timezoneList as $key => $timezone) {
                                                            ?>
                                                    <option value="<?php echo $key ?>"
                                                        <?php if($settinglist[0]['timezone']==$key){ echo 'selected' ; } ?>>
                                            ...
                                            <div class="col-sm-8">
                                                <select id="currency" name="sch_currency" class="form-control">
                                                    ...
                                                    <option value="<?php echo $currency ?>"
                                                        <?php if($settinglist[0]['currency']==$currency){ echo 'selected' ; } ?>>
                                            ...
                                            <div class="col-sm-8">
                                                <select id="time_format" name="time_format" class="form-control">
                                                    ...
                                                    foreach ($timeFormat as $time_k => $time_v) {
                                                        ?>
                                                    <option value="<?php echo $time_k ; ?>"
                                                        <?php if($settinglist[0]['time_format']==$time_k){ echo 'selected' ; } ?>>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="relative">
                                            ...
                                            <?php if (!$app_ver) {
                                                ?>
                                            <button type="button" class="btn btn-info btn-sm impbtntitle3"
                                                data-toggle="modal" data-target="#andappModal">Register Your Android
                                                App</button>
                                            <?php
                                            }
                                            ?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-sm-2">
                                                <?php echo $this->lang->line('mobile_app_api_url') ?></label>
                                            <div class="col-sm-10">
                                                <input type="text" name="mobile_api_url" id="mobile_api_url"
                                                    class="form-control"
                                                    value="<?php echo $settinglist[0]['mobile_api_url']; ?>">
                                                <span
                                                    class="text-danger"><?php echo form_error('mobile_api_url'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label
                                                class="col-sm-5"><?php echo $this->lang->line('app_primary_color_code'); ?></label>
                                            <div class="col-sm-7">
                                                <input type="text" name="app_primary_color_code"
                                                    id="app_primary_color_code" class="form-control"
                                                    value="<?php echo $settinglist[0]['app_primary_color_code']; ?>">
                                                <span
                                                    class="text-danger"><?php echo form_error('app_primary_color_code'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-6">
                                                <?php echo $this->lang->line('app_secondary_color_code'); ?></label>
                                            <div class="col-sm-6">
                                                <input type="text" name="app_secondary_color_code"
                                                    id="app_secondary_color_code" class="form-control"
                                                    value="<?php echo $settinglist[0]['app_secondary_color_code']; ?>">
                                                <span
                                                    class="text-danger"><?php echo form_error('app_secondary_color_code'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-sm-2">
                                                <?php echo $this->lang->line('mobile_app')." ".$this->lang->line('logo') ?></label>
                                            <?php
                                            ...
                                            <?php
						                            ...
						                            ?>
                                            <img src="<?php echo base_url('uploads/hospital_content/logo/'.$settinglist[0]['app_logo'].img_time()) ?>"
                                                class="" alt="" style="height: 15px;margin-top: 5px;">
                                            <?php
						                        }
						                        ?>
                                            <?php if ($this->rbac->hasPrivilege('general_setting', 'can_edit')) { ?>
                                            &nbsp;<a href="#" role="button"
                                                class="btn btn-primary btn-sm upload_applogo "
                                                data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i
                                                    class="fa fa-picture-o"></i>
                                                <?php echo $this->lang->line('edit')." ".$this->lang->line('app')." ".$this->lang->line('logo'); ?></a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <label class="radio-inline">
                                                    <input type="radio" name="doctor_restriction_mode" value="disabled"
                                                        <?php if($settinglist[0]['doctor_restriction']=='disabled'){ echo 'checked' ; } ?>><?php echo $this->lang->line('disabled'); ?>
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="doctor_restriction_mode" value="enabled"
                                                        <?php if($settinglist[0]['doctor_restriction']=='enabled'){ echo 'checked' ; } ?>><?php echo $this->lang->line('enabled'); ?>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-6">
                                                <?php echo $this->lang->line('superadmin_restriction'); ?></label>
                                            <div class="col-sm-6">
                                                <label class="radio-inline">
                                                    <input type="radio" name="superadmin_restriction_mode"
                                                        value="disabled"
                                                        <?php if($settinglist[0]['superadmin_restriction']=='disabled'){ echo 'checked' ; } ?>><?php echo $this->lang->line('disabled'); ?>
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="superadmin_restriction_mode"
                                                        value="enabled"
                                                        <?php if($settinglist[0]['superadmin_restriction']=='enabled'){ echo 'checked' ; } ?>><?php echo $this->lang->line('enabled'); ?>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('edit_logo'); ?> <span
                        id="imagesize">(182px X 18px)</span></h4>
            </div>
            <div class="modal-body">
                <form class="box_upload boxupload" id="ajaxlogo" method="post"
                    action="<?php echo site_url('schsettings/ajax_editlogo') ?>" enctype="multipart/form-data">
            ...
            <form action="<?php echo site_url('admin/admin/updateandappCode') ?>" method="POST" id="andapp_code">
                <div class="modal-body andapp_modal-body">
                    ...
                    <div class="form-group">
                        <label class="ainline"><span>Envato Market Purchase Code for Smart Hospital Android App ( <a
                                    target="_blank"
...
$('.upload_applogo').on('click', function(e) {
    e.preventDefault();
    $("#myModalLabel").html(
        '<?php echo $this->lang->line('edit')." ".$this->lang->line('app')." ".$this->lang->line('logo') ?> (152px X 18px)'
        );
...
$('.upload_minilogo').on('click', function(e) {
    e.preventDefault();
    $("#myModalLabel").html(
        '<?php echo $this->lang->line('edit') . " " . $this->lang->line('small') . " " . $this->lang->line('logo') ?> (41px X 25px)'
        );
