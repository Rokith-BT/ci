                                ...
                                <form method="post" id="loginForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username"
                                            ...
                                            class="form-username form-control" id="email"> <span
                                            class="text-danger"><?php echo form_error('username'); ?></span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger" id="password-error"><?php echo form_error('password'); ?></span>
                                    </div>
                                    <?php if ($is_captcha) { ?>
