        ...
        <ul class="sidebar-menu verttop">
            ...
            <li class="treeview <?php echo set_Topmenu('IPD_in_patient'); ?>">
                <a href="<?php echo base_url() ?>admin/patient/ipdsearch">
                    <i class="fas fa-procedures" aria-hidden="true"></i> <span>
                        <?php echo $this->lang->line('ipd'); ?></span>
                </a>
            </li>
            <?php
                }
            ...
            <li class="treeview <?php echo set_Topmenu('birthordeath'); ?>">
                <a href="<?php echo base_url(); ?>admin/birthordeath"><i class="fa fa-birthday-cake"
                        aria-hidden="true"></i><span> <?php echo $this->lang->line('birth_death_record'); ?></span><i
                ...
                <ul class="treeview-menu">
                    <?php
                            ...
                            ?>
                    <li class="<?php echo set_Submenu('birthordeath/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/birthordeath"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('birth_record'); ?> </a></li>
                    <?php
                                }
                            }
                            ...
                            if ($this->rbac->hasPrivilege('death_record', 'can_view')) {
                                ?>
                    <li class="<?php echo set_Submenu('birthordeath/death'); ?>"><a
                            href="<?php echo base_url(); ?>admin/birthordeath/death"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('death_record'); ?></a></li>
                    <?php } ?>
                </ul>
            </li>
            <?php
            ...
            <li class="treeview <?php echo set_Topmenu('finance'); ?>">
                <a href="<?php echo base_url(); ?>admin/patient/search">
                    <i class="fas fa-money-bill-wave"></i> <span><?php echo $this->lang->line('finance'); ?></span> <i
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?php echo set_Submenu('income/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/income"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('income'); ?> </a></li>
                    <?php
                                }
                            }
                    ...
                    <li class="<?php echo set_Submenu('expense/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/expense"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('expenses'); ?></a></li>
                    <?php
                                }
                            }
                            ?>
            ...
            <li class="treeview <?php echo set_Topmenu('Certificate'); ?>">
                <a href="#">
                    <i class="fa fa-newspaper-o ftlayer"></i>
                    <span><?php echo $this->lang->line('certificate'); ?></span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    ...
                    <li class="<?php echo set_Submenu('admin/generatecertificate'); ?>"><a
                            href="<?php echo base_url(); ?>admin/generatecertificate"><i
                                class="fas fa-angle-right"></i><?php echo $this->lang->line('certificate'); ?> </a></li>
                    <?php }
                            if ($this->rbac->hasPrivilege('generate_patient_id_card', 'can_view')) { ?>
                    <li class="<?php echo set_Submenu('admin/generatepatientidcard'); ?>"><a
                            href="<?php echo base_url('admin/generatepatientidcard/'); ?>"><i
                                class="fas fa-angle-right"></i><?php echo $this->lang->line('patient_id_card'); ?></a>
                    </li>
                    <?php }
                            if ($this->rbac->hasPrivilege('generate_staff_id_card', 'can_view')) { ?>
                    <li class="<?php echo set_Submenu('admin/generatestaffidcard'); ?>"><a
                            href="<?php echo base_url('admin/generatestaffidcard/'); ?>"><i
                                class="fas fa-angle-right"></i><?php echo $this->lang->line('staff_id_card'); ?></a>
                    </li>
                    <?php } ?>
                </ul>
            </li>
            ...
            <li class="treeview <?php echo set_Topmenu('conference'); ?>">
                <a href="#">
                    <i class="fa fa-video-camera ftlayer"></i>
                    <span><?php echo $this->lang->line('live_consultation'); ?></span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <?php if ($this->rbac->hasPrivilege('live_consultation', 'can_view')) { ?>
                    <li class="<?php echo set_Submenu('conference/live_consult'); ?>"><a
                            href="<?php echo base_url('admin/zoom_conference/consult'); ?>"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('live_consultation'); ?></a></li>
                    <?php }
                            if ($this->rbac->hasPrivilege('live_meeting', 'can_view')) { ?>
                    <li class="<?php echo set_Submenu('conference/live_meeting'); ?>"><a
                            href="<?php echo base_url('admin/zoom_conference/meeting'); ?>"><i
                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('live_meeting'); ?> </a>
                    </li>
                    <?php } ?>
                </ul>
            </li>
            ...
            <li class="treeview <?php echo set_Topmenu('Reports'); ?>">
                <a href="#">
                    <i class="fas fa-line-chart"></i> <span><?php echo $this->lang->line('reports'); ?></span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <?php if ($this->rbac->hasPrivilege('daily_transaction_report', 'can_view')) { ?>
                    <li class="<?php echo set_Submenu('admin/transaction/dailytransactionreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/transaction/transactionreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line("daily_transaction_report"); ?></a>
                    </li>

                    <?php }
                        if ($this->rbac->hasPrivilege('all_transaction_report', 'can_view')) { ?>

                    <li class="<?php echo set_Submenu('admin/income/alltransactionreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/income/alltransactionreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line("all_transaction_report"); ?></a>
                    </li>
                    <?php } ?>
                    <?php
                        if ($this->module_lib->hasActive('appointment')) {
                        ...
                        ?>
                    <li class="<?php echo set_Submenu('admin/appointment/appointmentreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/appointment/appointmentreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('appointment_report'); ?></a></li>
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('opd')) {
                            if ($this->rbac->hasPrivilege('opd_report', 'can_view')) {
                            ?><li class="<?php echo set_Submenu('admin/patient/opd_report'); ?>"><a
                            href="<?php echo base_url(); ?>admin/patient/opd_report"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('opd_report'); ?></a></li>
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('ipd')) {
                            ...
                            ?><li class="<?php echo set_Submenu('admin/patient/ipdreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/patient/ipdreport"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('ipd_report'); ?></a></li>
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('opd')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/patient/opdreportbalance'); ?>"><a
                            href="<?php echo base_url(); ?>admin/patient/opdreportbalance"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('opd_balance_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('ipd')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/patient/ipdreportbalance'); ?>"><a
                            href="<?php echo base_url(); ?>admin/patient/ipdreportbalance"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('ipd_balance_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('opd')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/patient/opddischargepatientReport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/patient/opddischargepatientreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('opd_discharged_patient'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('ipd')) {
                            if ($this->rbac->hasPrivilege('discharge_patient_report', 'can_view')) {
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/patient/dischargepatientreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/patient/dischargepatientreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('ipd_discharged_patient'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('pharmacy')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/pharmacy/billreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/pharmacy/billreport"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('pharmacy_balance_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('pharmacy')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/expmedicine/expmedicinereport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/expmedicine/expmedicinereport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('expiry_medicine_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('pathology')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/pathology/pathologyreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/pathology/pathologyreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('pathology_patient_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        if ($this->module_lib->hasActive('radiology')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/radio/radiologyreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/radio/radiologyreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('radiology_patient_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->rbac->hasPrivilege('ot_report', 'can_view')) {
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/operationtheatre/otreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/operationtheatre/otreport"><i
                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('ot_report'); ?></a></li> -->
                    <?php
                        }
                        ...
                        if ($this->module_lib->hasActive('blood_bank')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/bloodbank/bloodissuereport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/bloodbank/bloodissuereport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('blood_issue_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        if ($this->module_lib->hasActive('blood_bank')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/bloodbank/componentissuereport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/bloodbank/componentissuereport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('component_issue_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        if ($this->module_lib->hasActive('blood_bank')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/bloodbank/blooddonorreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/bloodbank/blooddonorreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('blood_donor_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('live_consultation')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('zoom_conference/consult_report'); ?>"><a
                            href="<?php echo base_url('admin/zoom_conference/consult_report'); ?>"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('live_consultation_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('live_consultation')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('zoom_conference/meeting_report'); ?>"><a
                            href="<?php echo base_url('admin/zoom_conference/meeting_report'); ?>"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('live_meeting_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('tpa_management')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/tpamanagement/tpareport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/tpamanagement/tpareport"><i
                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('tpa_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('income')) {
                            ...
                            ?>
                    <li class="<?php echo set_Submenu('admin/income/Collection'); ?>"><a
                            href="<?php echo base_url(); ?>admin/income/Collection"><i class="fas fa-angle-right"></i>
                            Collection Report</a></li>
                    <li class="<?php echo set_Submenu('admin/income/incomesearch'); ?>"><a
                            href="<?php echo base_url(); ?>admin/income/incomesearch"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('income_report'); ?></a></li>
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('income')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('reports/incomegroup'); ?>"><a
                            href="<?php echo base_url(); ?>admin/income/incomegroup"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('income_group_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('expense')) {
                            ...
                            ?>
                    <li class="<?php echo set_Submenu('admin/expense/expensesearch'); ?>"><a
                            href="<?php echo base_url(); ?>admin/expense/expensesearch"><i
                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('expense_report'); ?></a>
                    </li>
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('expense')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('reports/expensegroup'); ?>"><a
                            href="<?php echo base_url(); ?>admin/expense/expensegroup"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('expense_group_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('ambulance')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/vehicle/ambulancereport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/vehicle/ambulancereport"><i
                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('ambulance_report'); ?></a>
                    </li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('birth_death_report')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/birthordeath/birthreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/birthordeath/birthreport"><i
                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('birth_report'); ?></a>
                    </li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('birth_death_report')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/birthordeath/deathreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/birthordeath/deathreport"><i
                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('death_report'); ?></a>
                    </li> -->
                    <?php
                            }
                        }
                    ...
                    <?php
                        ...
                        ?>
                    <!-- <li class="<?php echo set_Submenu('admin/payroll/payrollsearch'); ?>"><a
                            href="<?php echo base_url(); ?>admin/payroll/payrollsearch"><i
                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('payroll_report'); ?></a>
                    </li> -->
                    <?php
                        }
                    ...
                    <li class="<?php echo set_Submenu('userlog/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/userlog"><i class="fas fa-angle-right"></i>
                    ...
                    <?php
                        ...
                        if ($this->module_lib->hasActive('patient')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/patient/patientcredentialreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/patient/patientcredentialreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('patient_login_credential'); ?></a></li> -->
                    <?php
                            }
                        }
                    ...
                    <!-- <li class="<?php echo set_Submenu('mailsms/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/mailsms/index"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('email_sms_log'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('inventory')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('Reports/itemreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/item/itemreport"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('inventory_stock_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('inventory')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('Reports/additemreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/item/additemreport"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('inventory_item_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('inventory')) {
                            ...
                            ?>
                    <!-- <li class="<?php echo set_Submenu('Reports/issueinventoryreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/issueitem/issueinventoryreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('inventory_issue_report'); ?></a></li> -->
                    <?php
                            }
                        }
                        ...
                        if ($this->rbac->hasPrivilege('audit_trail_report', 'can_view')) {
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/audit/index'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/audit/index"><i class="fas fa-angle-right"></i>
                                    <?php echo $this->lang->line('audit_trail_report'); ?></a></li> -->
                    <?php
                        }
                        if ($this->module_lib->hasActive('patient')) {
                            if ($this->rbac->hasPrivilege('patient_visit_report', 'can_view')) {
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/patient/patientvisitreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/patient/patientvisitreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line("patient_visit_report"); ?></a></li> -->
                    <?php }
                        }
                        if ($this->module_lib->hasActive('bill')) {
                            if ($this->rbac->hasPrivilege('patient_bill_report', 'can_view')) {
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/patient/patientbillreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/patient/patientbillreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line("patient_bill_report"); ?></a></li> -->
                    <?php }
                        }
                        if ($this->module_lib->hasActive('referral')) {
                            if ($this->rbac->hasPrivilege('referral_report', 'can_view')) {
                            ?>
                    <!-- <li class="<?php echo set_Submenu('admin/referral/report'); ?>"><a
                            href="<?php echo base_url(); ?>admin/referral/report"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line("referral_report"); ?></a></li> -->
                    <?php }
                        } ?>
            ...
            <li class="treeview <?php echo set_Topmenu('setup'); ?>">
                <a href="<?php echo base_url(); ?>">
                    <i class="fas fa-cogs"></i> <span><?php echo $this->lang->line('setup'); ?></span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    ...
                    <li class="<?php echo set_Submenu('schsettings/index'); ?>"><a
                            href="<?php echo base_url(); ?>schsettings"><i class="fas fa-angle-right"></i>
                    ...
                    <li class="<?php echo set_Submenu('setup/patient'); ?>"> <a
                            href="<?php echo base_url(); ?>admin/admin/search"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('patient'); ?></a></li>
                    <?php
                            }
                        }
                        ...
                        if ($this->rbac->hasPrivilege('hospital_charges', 'can_view')) {
                            ?>
                    <li class="<?php echo set_Submenu('charges/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/charges"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('hospital_charges'); ?></a></li>
                    <?php
                        }
                        if ($this->module_lib->hasActive('ipd')) {
                            if ($this->rbac->hasPrivilege('bed', 'can_view')) {
                            ?>
                    <li class="<?php echo set_Submenu('bed'); ?>"><a
                            href="<?php echo base_url(); ?>admin/setup/bed/status"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('bed'); ?></a></li>
                    <?php
                            }
                        }
                        ...
                        if (($this->rbac->hasPrivilege('opd_prescription_print_header_footer', 'can_view')) || ($this->rbac->hasPrivilege('ipd_bill_print_header_footer', 'can_view')) || ($this->rbac->hasPrivilege('ipd_prescription_print_header_footer', 'can_view')) || ($this->rbac->hasPrivilege('pharmacy_bill_print_header_footer', 'can_view')) || ($this->rbac->hasPrivilege('print_payslip_header_footer', 'can_view')) || ($this->rbac->hasPrivilege('birth_print_header_footer', 'can_view')) || ($this->rbac->hasPrivilege('death_print_header_footer', 'can_view'))) {
                            ?>
                    <li class="<?php echo set_Submenu('admin/printing'); ?>"><a
                            href="<?php echo base_url(); ?>admin/printing"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('print_header_footer'); ?></a></li>
                    <?php
                        }
                        if ($this->module_lib->hasActive('front_office')) {
                    ...
                    <li class="<?php echo set_Submenu('admin/visitorspurpose'); ?>"><a
                            href="<?php echo base_url(); ?>admin/visitorspurpose"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('front_office'); ?></a></li>
                    <?php
                            }
                        }
                        if (($this->rbac->hasPrivilege('operation', 'can_view')) || ($this->rbac->hasPrivilege('operation_category', 'can_view'))) {
                            ?>
                    <li class="<?php echo set_Submenu('operation_theatre/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/operationtheatre/index"><i
                    ...
                    <?php
                        ...
                        if ($this->module_lib->hasActive('pharmacy')) {
                            ...
                            ?>
                    <li class="<?php echo set_Submenu('medicine/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/medicinecategory/index"><i
                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('pharmacy'); ?></a></li>
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('pathology')) {
                            ...
                            ?>
                    <li class="<?php echo set_Submenu('addCategory/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/pathologycategory/addcategory"><i
                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('pathology'); ?></a></li>
                    <?php
                            }
                        }
                        if ($this->module_lib->hasActive('radiology')) {
                            ...
                            ?>
                    <li class="<?php echo set_Submenu('addlab/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/lab/addlab"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('radiology'); ?></a></li>
                    <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasActive('blood_bank')) {
                            ...
                            ?>
                    <li class="<?php echo set_Submenu('admin/bloodbank'); ?>"><a
                            href="<?php echo base_url(); ?>admin/bloodbank/products"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('blood_bank'); ?></a></li>
                    <?php
                            }
                        }
                        if (($this->rbac->hasPrivilege('symptoms_type', 'can_view')) || ($this->rbac->hasPrivilege('symptoms_head', 'can_view'))) {
                            ?>
                    <li class="<?php echo set_Submenu('symptoms/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/symptoms"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('symptoms'); ?></a></li>
                    <?php
                        }

                        if (($this->rbac->hasPrivilege('finding', 'can_view')) || ($this->rbac->hasPrivilege('finding', 'can_view'))) {
                        ?>
                    <li class="<?php echo set_Submenu('finding/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/finding"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('findings'); ?></a></li>
                    <?php
                        }
                    ...
                    <li class="<?php echo set_Submenu('finance/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/incomehead"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('finance'); ?></a></li>
                    <?php } else { ?>
                    <li class="<?php echo set_Submenu('finance/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/expensehead"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('finance'); ?></a></li>
                    ...
                    <?php
                        ...
                        if (($this->rbac->hasPrivilege('leave_types', 'can_view')) || ($this->rbac->hasPrivilege('leave_types', 'can_view'))) {
                            ?>
                    <li class="<?php echo set_Submenu('hr/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/leavetypes"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('human_resource'); ?></a></li>
                    <?php
                        } ?>
                    <?php if ($this->module_lib->hasActive('referral')) {
                            if ($this->rbac->hasPrivilege('referral_commission', 'can_view')) {  ?>
                    <li class="<?php echo set_Submenu('admin/referral/commission'); ?>"><a
                            href="<?php echo base_url(); ?>admin/referral/commission"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('referral'); ?></a></li>
                    <?php }
                        }
                        if ($this->module_lib->hasActive('appointment')) {
                    ...
                    <li class="<?php echo set_Submenu('admin/onlineappointment'); ?>"><a
                            href="<?php echo base_url(); ?>admin/onlineappointment/"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('appointment'); ?></a></li>
                    <?php  }
                        }
                        if ($this->module_lib->hasActive('inventory')) {
                            if ($this->rbac->hasPrivilege('item_category', 'can_view')) {
                            ?>
                    <li class="<?php echo set_Submenu('inventory/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/itemcategory"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('inventory'); ?></a></li>
                    <?php }
                        }
