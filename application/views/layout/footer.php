...
<footer class="main-footer">
    <div class="footer-links">
        <a target="_blank" href="<?php echo base_url(); ?>admin/admin/privacy_policy">Privacy Policy</a>
        <a target="_blank" href="<?php echo base_url(); ?>admin/admin/terms">Terms and Conditions</a>
        <a target="_blank" href="<?php echo base_url(); ?>admin/admin/refundpolicy">Refund Policy</a>
        <a href="https://plenome.com/contact-us/">Contact Us</a>
    </div>
...
?>
    <script
        src="<?php echo base_url(); ?>backend/plugins/datepicker/locales/bootstrap-datepicker.<?php echo $language_name ?>.js">
    </script>
...
<div class="row">
    <div class="modal fade" id="sessionModal" tabindex="-1" role="dialog" aria-labelledby="sessionModalLabel">
        <form action="<?php echo site_url('admin/admin/activeSession') ?>" id="form_modal_session"
...
<script type="text/javascript">
            ...
            ajax: {
                ...
                processResults: function(response, params) {
                    if (/^\d{10}$/.test(params.term)) {
                        let mobileNumber = params.term;
                        $('#number').val(mobileNumber);
                        // console.log("Empty response for 10-digit number:", mobileNumber);
                    } else {
                        $('#number').val('');
                        // console.log("Results found, clearing mobile number field.");
                    }
                    return {
                        results: response
                    };
    ...
    var calendar_date_time_format =
        '<?php echo $result = strtr($this->customlib->getHospitalDateFormat(), ['d' => 'DD', 'm' => 'MM', 'M' => 'MMM', 'Y' => 'YYYY']) ?>';
    $(document).ready(function() {
