                                    ...
                                    <div class="">
                                        <div class="col-md-7">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                <div class="material-switch">
                                                        <input id="enable_online_appointment" name="is_active_online_appointment" type="checkbox" class="chk" value="1" 
                                                            <?php 
                                                                $isActive = isset($frontcmslist->is_active_online_appointment) ? $frontcmslist->is_active_online_appointment : 0;
                                                                echo set_checkbox('is_active_online_appointment', '1', ($isActive == 1) ? true : false); 
                                                            ?>>
