                    ...
                    <div class="box-body">
                        <div class="row text-center">
                            ...
                            <div class="col-md-4 col-md-offset-4">
                                <div
                                    class="alert <?php echo (isset($version) && $version != "") ? 'alert-danger':'alert-success' ?>">
                                    <p class="versionup">
                                        <?php echo $this->lang->line('your_app_name_version'); ?> <span>
                                            <?php echo $current_version; ?></span></p>
                                </div>
                                <!--./alert alert-danger-->
                            </div>
                            <!--./col-md-4 -->
                            ...
                            <div class="col-md-4 col-md-offset-4">
                                <div class="alert alert-success">
                                    <p class="versionup"><?php echo $this->lang->line('latest_app_name_version'); ?>
                                        <span> <?php echo $version; ?></span></p>
                                </div>
                                <!--./alert alert-danger-->
                            </div>
                            <!--./col-md-4 -->
                                ...
                                <div class="text-success">
                                    <ul class="update-list">
                                        ...
                                        foreach ($this->session->flashdata('message') as $message_key => $message_value) {
                                            ?>
                                        <li>
                                            <h5><i class="fa fa-info-circle"></i> <?php echo $message_value; ?></h5>
                                        </li>
                                        <?php
                                        }
                                        ?>
                        ...
                        if (!$this->session->flashdata('message') && $this->session->flashdata('error')) {
                                ...
                                <div class="text-danger">
                                    <ul class="update-list">
                                        ...
                                        foreach ($this->session->flashdata('error') as $error_key => $error_value) {
                                            ?>
                                        <li>
                                            <h5><i class="fa fa-info-circle"></i> <?php echo $error_value; ?></h5>
                                            <?php
                                        }
                                        ?>
                                    </ul>
                            ...
                            <div class="col-md-12 mb10 mt10 upgradeup">
                                ...
                                <form method="POST" action="<?php echo site_url('admin/updater'); ?>" id="form-update">
                                    <button type="button" class="btn cfees btn-submit" name="update_btn" value="update">
                                        <?php echo $this->lang->line('update_now')?></button>
                                </form>
                            </div>
                            <!--./col-md-12-->
                            <?php
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer"><button type="button"
                    class="btn cfees pull-right confirm-yes"><?php echo $this->lang->line('yes'); ?> </button></div>
        </div>
    </div>
</div>
