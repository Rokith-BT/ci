                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right noExport">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('store', 'can_delete')) { ?>
                                                        <a class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_iteam('<?php echo $store['id'] ?>')">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="addstoreitem" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
<script>
    $(document).ready(function() {
        $('#addstoreitem').on('submit', function(e) {
            e.preventDefault();
            var formData = {
                item_store: $('#name').val(),
                code: $('#code').val(),
            ...
            $.ajax({
                url: '<?= $api_base_url ?>setup-inventory-item-store',
                type: 'POST',
                data: formData,
                beforeSend: function() {
                ...
                success: function(response) {
                    successMsg('Store Iteam add successfully');
                    location.reload();
                },
                complete: function() {
...
<script>
    ...
    $(document).ready(function() {
        $('#editformadd').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?= $api_base_url ?>setup-inventory-item-store/' + store_id,
                type: 'PATCH',
                data: formData,
                beforeSend: function() {
                ...
                success: function(response) {
                    successMsg('Store Iteam update successfully');
                    location.reload();
                },
                complete: function() {
...
<script>
    function delete_iteam(id) {
        var conf = confirm("Are you sure you want to delete this Item Store?");
        if (conf == true) {
            $.ajax({
                url: '<?= $api_base_url ?>setup-inventory-item-store/' + id,
                type: 'delete',
                success: function(data) {
