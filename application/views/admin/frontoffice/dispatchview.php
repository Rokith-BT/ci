                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <input class="" type='hidden' name='file' id="old_file" />
                                        </div>
                                        <span class="text-danger"><?php echo form_error('file'); ?></span></div>
                                </div>
                        </div>
...
<script type="text/javascript">
    ...
    function get(id) {
        ...
        function submitForm(data) {
            $.ajax({
                url: '<?=$api_base_url?>postal-receive-dispatch',
                type: "POST",
     ...
     function delete_ById(id){
        if (confirm('<?php echo $this->lang->line('delete_confirm')?>')) {
         $.ajax({
            dataType: 'json',
            url: '<?=$api_base_url?>postal-receive-dispatch/removeFrontofficePostalDispatch/' + id + '?hospital_id=<?=$data['hospital_id']?>',
            type: 'DELETE',
            success: function (result) {
...
function submitForm1(data) {
    let editid =$('#id').val();
    $.ajax({
        url: '<?=$api_base_url?>postal-receive-dispatch/' + editid,
        type: "PATCH",
        data: JSON.stringify(data),
        contentType: 'application/json',
        dataType: 'json',
