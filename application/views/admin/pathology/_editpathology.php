...
?>
<input type="hidden" name="pathology_billing_id" value="<?php echo $pathology_data->id; ?>" id='pathology_billing_id'>
  <div class="row">        
...
<input type="hidden" id='ipd_prescription_basic_id' value='<?php echo  $report_value->ipd_prescription_basic_id;?>'>
<?php
?>
...
<input type="hidden" name="inserted_id_<?php echo $total_rows;?>" value="<?php echo  $report_value->id;?>">
                                            ...
                                            <td>
                                                 <button onclick='removepathoreport(<?php echo  $report_value->id;?>)'type="button"  class="closebtn delete_rows" data-row-id="<?php echo $total_rows;?>" autocomplete="off"><i class="fa fa-remove"></i></button>
                                            </td>
                                        </tr>
<?php 
$total_rows++;
...
<?php }?>
                    ...
                    <script>
                        function removepathoreport(id)
                        {
                            $.ajax({
                                type: "Delete",
                                url: "<?=$api_base_url?>pathology-generate-bill/removepathoreport/" + id + "?hospital_id=<?=$data['hospital_id']?>",                               
