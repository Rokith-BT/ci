            ...
            <div class="col-md-5">
                <table class="table table-hover table-sm">
                    ...
                    <tr>
                        ...
                        <td><?php echo composeStaffNameByString($result->name, $result->surname, $result->employee_id); ?>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="col-md-2">
                <table class="table table-hover table-sm">
                    ...
                    <tr>
                        ...
                        <td><?php echo $this->customlib->getPatientAge($result->age, $result->month, $result->day); ?>
                        </td>
                    </tr>
                    <tr>
...
echo $this->customlib->YYYYMMDDTodateFormat($report_value->parameter_update);
    ...
    ?>
                            ...
                            <td class="text-right">
                                <?php echo $currency_symbol . $taxamount . "(" . $report_value->tax_percentage . "%)"; ?>
                            </td>
...
if ($is_bill) {if ($this->rbac->hasPrivilege('pathology_add_edit_collection_person', 'can_view')) {
        ?>
                                ...
                                <a href='javascript:void(0)'
                                    ...
                                    data-record-id='<?php echo $report_value->id; ?>'
                                    class='btn btn-default btn-xs add_collection' data-toggle='tooltip'
                                    title='<?php echo $this->lang->line("add_edit_collection_person"); ?>'><i
                                        class='fa fa-user-plus'></i></a>
                                <?php
}if ($this->rbac->hasPrivilege('pathology_add_edit_report', 'can_view')) {
        if ($report_value->collection_specialist_staff_employee_id != "") {
            ?>
                                <a href='javascript:void(0)'
                                    data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>'
                                    data-record-id='<?php echo $report_value->id; ?>'
                                    class='btn btn-default btn-xs add_report' data-toggle='tooltip'
                                    title='<?php echo $this->lang->line("add_edit_report"); ?>'><i
    ...
    ?>
                                <a href='javascript:void(0)'
                                    data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>'
                                    data-record-id='<?php echo $report_value->id; ?>'
                                    class='btn btn-default btn-xs print_pathology_report' data-toggle='tooltip'
                                    title='<?php echo $this->lang->line("print"); ?>'><i class='fa fa-print'></i></a>
                                <?php
if ($report_value->pathology_report != "") {
        ?>
                                <a href="<?php echo site_url('admin/pathology/downloadReport/' . $report_value->id) ?>"
                                    class='btn btn-default btn-xs' data-toggle='tooltip'
                                    title='<?php echo $this->lang->line("download"); ?>'><i
