...
<div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <table class="table table-hover table-sm">
                    <tr>
                        ...
                        <td class="col-lg-3">
                            <?php echo $this->customlib->getSessionPrefixByType('pathology_billing').$pathology_billing->id ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo composeStaffNameByString($pathology_billing->name,$pathology_billing->surname,$pathology_billing->employee_id); ?>
                        </td>
                    </tr>
                    <tr>
    ...
    <div class="col-lg-5 col-md-5 col-sm-5">
        ...
        <form id="<?php echo $form_id;?>" action="<?php echo site_url('admin/pathology/partialbill')?>"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label><?php echo $this->lang->line('amount') . " (" . $currency_symbol . ")"; ?></label><small
                            class="req"> *</small>
                        <input type="text" name="amount" value="<?= $balance_amount; ?>" id="amount"
...
foreach ($pathology_transaction as $transaction_key => $transaction) {
	?>
            <tr>
                ...
                <td><?php echo $this->customlib->YYYYMMDDHisTodateFormat($transaction->payment_date,$this->customlib->getHospitalTimeFormat()); ?>
                </td>
                <td>
    ...
    ?>
                    <a href='<?php echo site_url('admin/transaction/download/'.$transaction->id);?>'
                        class='btn btn-default btn-xs' title='<?php echo $this->lang->line('download'); ?>'><i
        ...
        if($is_bill){
            ?>
                    <a href='javascript:void(0)' data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>'
                        data-record-id="<?php echo $transaction->id;?>"
                        class='btn btn-default btn-xs print_patho_receipt' data-toggle='tooltip'
                        title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a>

                    <?php
        }else{ 
            ?>
                    <a href='javascript:void(0)' data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>'
                        data-record-id="<?php echo $transaction->id;?>" class='btn btn-default btn-xs print_receipt'
                        data-toggle='tooltip' title='<?php echo $this->lang->line('print'); ?>'><i
                    ...
                    <a href='javascript:void(0)' data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>'
                        data-record-id="<?php echo $transaction->id;?>" class='btn btn-default btn-xs delete_trans'
                        data-toggle='tooltip' title='<?php echo $this->lang->line('delete'); ?>'><i
