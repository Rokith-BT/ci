    ...
    <script type="text/javascript">
        ...
        function delete_batch(id, pharmacy_id) {
            if (confirm('<?= $this->lang->line('are_you_sure'); ?>')) {
                $.ajax({
                    url: '<?= $api_base_url ?>pharmacy/MedicineGoodStock/' + id + '?hospital_id=<?= $data['hospital_id'] ?>',
                    type: "DELETE",
                    dataType: 'json',
        ...
        function delete_badstock(id, pharmacy_id, medicine_batch_details_id) {
            if (confirm('<?php echo $this->lang->line('are_you_sure'); ?>')) {
                $.ajax({
                    url: '<?=$api_base_url?>pharmacy/deleteBadMedicineStock/' + id + '/' + '?hospital_id=<?=$data['hospital_id']?>',
                    type: "DELETE",                  
                    dataType: 'json',
                    success: function (data) {
                        if (data.status == 'success') {
