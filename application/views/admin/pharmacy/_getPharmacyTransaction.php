            ...
            <tr>
                ...
                <td class="text-right"><?php echo amountFormat(($pharmacy_bill_detail['net_amount'] + $pharmacy_bill_detail['refund_amount'] )-$pharmacy_bill_detail['paid_amount']); ?></td>
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        ...
                        <form id="<?php echo $form_id; ?>"  accept-charset="utf-8" method="post"  >
...
<div class="row cheque_div" style="display: none;">
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="filestyle form-control"   name="document" id="cheque_file">
...
<tr>
    ...
    if ($this->rbac->hasPrivilege('pharmacy_partial_payment', 'can_delete')) { ?>
        <a  data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>'           
           class='btn btn-default btn-xs delete_trans'  
           data-toggle='tooltip' 
...
echo $this->lang->line('no_record_found');
  ...
  <script>
    ...
    if (confirm("Are you sure you want to delete this transaction?")) {
        $.ajax({
            url: '<?=$api_base_url?>pharmacy-generate-bill/deletePayment/'+ transactionId + '?Hospital_id=<?=$data['hospital_id']?>', // Update with your actual endpoint
            type: 'DELETE',
