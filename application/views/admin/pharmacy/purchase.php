                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('medicine_purchase', 'can_add')) { ?>
                                <a data-toggle="modal" onclick="holdModal('myModal')"
                                    class="btn btn-primary btn-sm addpurchase"><i class="fa fa-plus"></i>
                                    <?php echo $this->lang->line('purchase_medicine'); ?></a>
                            <?php } ?>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <table class="table table-striped table-bordered table-hover ajaxlist" cellspacing="0"
                            width="100%" data-export-title="<?php echo $this->lang->line('medicine_purchase_list'); ?>">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-right">
                                        <?php echo $this->lang->line('total') . " (" . $currency_symbol . ")"; ?></th>
                                    <th class="text-right">
                                        <?php echo $this->lang->line('tax') . " (" . $currency_symbol . ")"; ?></th>
                                    <th class="text-right">
                                        <?php echo $this->lang->line('discount') . " (" . $currency_symbol . ")"; ?></th>
                                    <th class="text-right">
                                        <?php echo $this->lang->line('net_amount') . " (" . $currency_symbol . ")"; ?></th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-5 col-md-5 col-sm-5">
                                    <label><?php echo $this->lang->line('bill_no'); ?> <input name="invoice_no"
                                            id="invoice_no" type="text" value=""
                                            class="transparentbg-border active-border" />
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 text-right text-md-left">
                                    <label><?php echo $this->lang->line('purchase_date'); ?>
                                        <input name="date" id="txtDate10" type="text"
                                            class="transparentbg-border datetime" />
                                ...
                                <div class="row">
                                    <div class="col-sm-2" hidden>
                                        <div class="form-group">
                                            <label>
                                                <th><?php echo $this->lang->line('supplier_person'); ?></th>
                                            </label>
                                            <small class="req"> *</small>
                                            <input name="supplier_name" readonly hidden id="supplier_name" type="text"
                                                class="form-control" />
                                    ...
                                    <div class="col-md-12 mt10">
                                        <div class="table-responsive">
                                            <table
                                                class="table tableover table-striped table-bordered table-hover mb10 tablefull12"
                                                id="tableID">
                                                <thead>
                                                    <tr class="white-space-nowrap">
                                                        <th width="10%">
                                                            <?php echo $this->lang->line('medicine_category'); ?><small
                                                                class="req"> *</small></th>
                                                        <th width="10%">
                                                            <?php echo $this->lang->line('medicine_name'); ?><small
                                                                class="req" style="color:red;"> *</small></th>
                                                        <th><?php echo $this->lang->line('batch_no'); ?><small
                                                                class="req"> *</small></th>
                                                        <th><?php echo $this->lang->line('expiry_date'); ?><small
                                                                class="req"> *</small></th>
                                                        <th><?php echo $this->lang->line('mrp') . " " . ' (' . $currency_symbol . ')'; ?><small
                                                                class="req"> *</small></th>
                                                        <th><?php echo $this->lang->line('batch_amount') . " " . ' (' . $currency_symbol . ')'; ?>
                                                        <small class="req"> *</small>
                                                        </th>

                                                        <th><?php echo $this->lang->line('sale_price') . " " . ' (' . $currency_symbol . ')'; ?><small
                                                                class="req"> *</small></th>
                                                        <th><?php echo $this->lang->line('packing_qty'); ?>
                                                        <small class="req"> *</small>
                                                    </th>

                                                        <th class="text-right;">
                                                            <?php echo $this->lang->line('quantity'); ?><small
                                                                class="req"> *</small> </th>
                                                        <th class="text-right">
                                                            <?php echo $this->lang->line('purchase_price') . " " . ' (' . $currency_symbol . ')'; ?><small
                                                                class="req"> *</small></th>
                                                        <th class="text-right">
                                                            <?php echo $this->lang->line('tax'); ?><small class="req">
                                                                *</small></th>
                                                        <th class="text-right">
                                                            <?php echo $this->lang->line('amount') . " (" . $currency_symbol . ")"; ?><small
                                                                class="req"> *</small></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr id="row0" class="white-space-nowrap">
                                                        <td>
                                                            <select class="form-control" name='medicine_category_id[]'
                                                                onchange="getmedicine_name(this.value, '0')">
                                                                <option
                                                                    value="<?php echo set_value('medicine_category_id'); ?>">
                                                            ...
                                                            <span
                                                                class="text-danger"><?php echo form_error('medicine_category_id[]'); ?>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <select class="form-control select2" style="width:100%"
                                                                onchange="getmedicinedetails(this.value, 0)"
                                                                id="medicine_name0" name='medicine_name[]'>
                                                                <option value="">
                                                                    <?php echo $this->lang->line('select'); ?>
                                                                </option>
                                                            </select>
                                                            <span
                                                                class="text-danger"><?php echo form_error('medicine_name[]'); ?>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="batch_no[]" id="batchno"
                                                                class="form-control">
                                                            <span
                                                                class="text-danger"><?php echo form_error('batch_no[]'); ?>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="expiry_date[]" id="expiry"
                                                                class="form-control">
                                                            <span
                                                                class="text-danger"><?php echo form_error('expiry_date[]'); ?>
                                                            </span>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input type="text" name="batch_amount[]" id="batch_amount"
                                                                class="form-control">
                                                            <span class="text-danger"></span>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="sale_rate[]" id="sale_price"
                                                                class="form-control">
                                                            <span
                                                                class="text-danger"><?php echo form_error('sale_rate[]'); ?>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="packing_qty[]" id="packing_qty"
                                                                class="form-control">
                                                            <span
                                                                class="text-danger"><?php echo form_error('packing_qty[]'); ?>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" name="quantity[]"
                                                                    onchange="multiply(0)" id="quantity0"
                                                                    class="form-control text-right">
                                                            </div>
                                                        </td>
                                                        <td class="text-right">
                                                            <input type="text" name="purchase_price[]"
                                                                onchange="multiply(0)" id="purchase_price0"
                                                                placeholder="" class="form-control text-right">
                                                            <span
                                                                class="text-danger"><?php echo form_error('purchase_price[]'); ?></span>
                                                        </td>
                                                        <td class="text-right">
                                                            <div class="">
                                                                <div class="input-group">
                                                                    <input type="text" change="multiply(0)"
                                                                        class="form-control right-border-none"
                                                                        name="purchase_tax[]" id="purchase_tax0"
                                                                        autocomplete="off">
                                                        ...
                                                        <td class="text-right" width="10%">
                                                            <input type="text" name="amount[]" id="amount0"
                                                                placeholder="" class="form-control text-right">
                                                            <span
                                                                class="text-danger"><?php echo form_error('net_amount[]'); ?></span>
                                                        </td>
                                                        <td><button type="button" onclick="addMore()"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-5">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="note" rows="3" id="note"
                                                ...
                                                <table class="printablea4">
                                                    <tr>
                                                        ...
                                                        <td width="60%" colspan="2" class="text-right ipdbilltable">
                                                            <input type="text" placeholder="Total" value="0"
                                                                name="total" id="total" style="width: 50%; float: right"
                                                                class="form-control" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-right ipdbilltable">
                                                            <h4
                                                                ...
                                                                value="" name="discount_percent" id="discount_percent"
                                                        ...
                                                        <td class="text-right ipdbilltable"><input type="text"
                                                                ...
                                                                id="discount" style="width: 85%; float: right"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right ipdbilltable">
                                                            <h4 style="float: right;font-size: 12px;padding-left: 5px;">
                                                            </h4>
                                                        </td>
                                                        <td class="text-right ipdbilltable">
                                                            <input type="text" placeholder="Tax amount" name="tax"
                                                                value="0" id="tax" style="width: 85%; float: right"
                                                                class="form-control" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td colspan="2" class="text-right ipdbilltable">
                                                            <input type="text" placeholder="Net Amount" value="0"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <span
                                                                class="text-danger"><?php echo form_error('payment_mode'); ?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="payment_note"
                                                                class="form-control"></textarea>
                                                            <span
                                                                class="text-danger"><?php echo form_error('payment_note'); ?></span>
                                                        </div>
                                                    </div>
                ...
                <div class="box-footer sticky-footer">
                    <div class="pull-right">
                        ...
                        <button type="submit" data-loading-text="<?php echo $this->lang->line('processing'); ?>"
                            style="display: none" id="billsave" class="btn btn-info pull-right"><i
...
<div class="modal fade" id="viewModal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog pup100" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-toggle="tooltip" title="" data-dismiss="modal"
                    data-original-title="Close" autocomplete="off">&times;</button>
                <div class="modalicon">
                    <div id='edit_deletebill'>
                        <a href="#" data-toggle="tooltip" data-placement="bottom" data-target="#edit_prescription"
...
<div class="modal fade" id="edit_bill" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog pup100" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" data-toggle="tooltip" title="<?php echo $this->lang->line('close'); ?>"
                    class="close" data-dismiss="modal">&times;</button>
                <div
                    class="d-flex align-items-center align-content-center align-items-start flex-column label-0 mobile-p-2">
                    <div class="p-2 d-inline-flex mobile-p-2 form-group mb0">
                        <select style="width:200px;" onchange="get_SupplierDetails(this.value)"
                            class="form-control select2" id="editsupplier" name='supplier'>
                            <option value=""><?php echo $this->lang->line('select_supplier'); ?></option>
                            <?php foreach ($supplierCategory as $dkey => $dvalue) { ?>
                                <option value="<?php echo $dvalue["id"]; ?>" <?php
                                                                                if ((isset($supplier_select)) && ($supplier_select == $dvalue["id"])) {
...
<script>
    $(document).ready(function() {
        $("#bill").on('submit', function(e) {
            ...
            dataObject["invoice_no"] = formData.get("invoice_no");
            dataObject["date"] = formatDate(formData.get("date"));
            dataObject["supplier_id"] = formData.get("supplier_id");
            dataObject["total"] = formData.get("total");
            dataObject["tax"] = formData.get("tax");
            dataObject["discount"] = formData.get("discount");
            dataObject["net_amount"] = formData.get("net_amount");
            dataObject["note"] = formData.get("note");
            dataObject["payment_mode"] = formData.get("payment_mode");
            dataObject["payment_date"] = formatDate(formData.get("payment_date"));
            dataObject["received_by"] = <?= $data['id'] ?>;
            dataObject["payment_note"] = formData.get("payment_note");
            dataObject["hospital_id"] = <?= $data['hospital_id'] ?>;

            // Validation for main form fields
            if (!dataObject["invoice_no"]) errorMessages.push('Invoice number is required.');
            if (!dataObject["date"]) errorMessages.push('Date is required.');
            if (!dataObject["supplier_id"]) errorMessages.push('Supplier ID is required.');
            if (!dataObject["total"]) errorMessages.push('Total amount is required.');
            if (!dataObject["tax"]) errorMessages.push('Tax amount is required.');
            if (!dataObject["discount"]) errorMessages.push('Discount amount is required.');
            if (!dataObject["net_amount"]) errorMessages.push('Net amount is required.');

            // Collecting medicines data
            var medicine_category_ids = formData.getAll('medicine_category_id[]');
            var medicine_names = formData.getAll('medicine_name[]');
            var batch_nos = formData.getAll('batch_no[]');
            var expiry_dates = formData.getAll('expiry_date[]');
            var mrps = formData.getAll('mrp[]');
            var batch_amounts = formData.getAll('batch_amount[]');
            var sale_rates = formData.getAll('sale_rate[]');
            var packing_qtys = formData.getAll('packing_qty[]');
            var quantities = formData.getAll('quantity[]');
            var purchase_prices = formData.getAll('purchase_price[]');
            var purchase_taxes = formData.getAll('purchase_tax[]');
            var amounts = formData.getAll('amount[]');
            var purchase_tax_rates = formData.getAll('purchase_tax[]');

            for (var i = 0; i < medicine_category_ids.length; i++) {
                var medicineEntry = {
                    "pharmacy_id": parseInt(medicine_names[i]) || null,
                    "inward_date": formatDate(formData.get('date')),
                    "expiry": formatDate(expiry_dates[i]),
                    "batch_no": batch_nos[i],
                    "packing_qty": packing_qtys[i],
                    "purchase_rate_packing": batch_amounts[i],
                    ...
                    "tax": purchase_taxes[i],
                    "hospital_id": <?= $data['hospital_id'] ?>
                };

                // Validation for medicine fields
                if (!medicineEntry.pharmacy_id) errorMessages.push('Medicine name is required.');
                if (!medicineEntry.expiry) errorMessages.push('Expiry date is required.');
                if (!medicineEntry.batch_no) errorMessages.push('Batch number is required.');
                if (!medicineEntry.mrp) errorMessages.push('MRP is required.');
                if (!medicineEntry.purchase_rate_packing) errorMessages.push('Batch amount is required.');
                if (!medicineEntry.sale_rate) errorMessages.push('Sale price is required.');
                if (!medicineEntry.packing_qty) errorMessages.push('Packing quantity is required.');
                if (!medicineEntry.quantity) errorMessages.push('Quantity is required.');
                if (!medicineEntry.purchase_price) errorMessages.push('Purchase price is required.');
                if (!medicineEntry.amount) errorMessages.push('Amount is required.');

                medicines.push(medicineEntry);
            }

            if (medicines.length === 0) errorMessages.push('At least one medicine entry is required.');
            if (errorMessages.length > 0) {
                errorMsg(errorMessages.join('<br>'));
                return;
            }
            dataObject['medicines'] = medicines;
            ...
            if (file) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.data) {
                            dataObject.file = response.data;
                            dataObject.attachment_name = file.name;
                        }
                        processFormData();
                    },
                    error: function() {
                        alert("File upload failed. Using existing document.");
                        processFormData();
                    }
                });
            } else {
                dataObject.file = " ";
                dataObject.attachment_name = " ";
                processFormData();
            }
            ...
            function processFormData() {
                ...
                $.ajax({
                    url: '<?= $api_base_url ?>purchase-medicine',
                    type: 'POST',
                    data: jsonString,
                    contentType: 'application/json',
                    success: function(response) {
                        let supplierBillId = response[0]?.["data "]?.Purchase_medicine_Values[0]?.id;
                        if (supplierBillId) {
                            dataObject.medicines.forEach(medicine => {
                                medicine.supplier_bill_basic_id = supplierBillId;
                            });
                            var medicinesJson = JSON.stringify(dataObject.medicines, null, 2);
                            $.ajax({
                                url: '<?= $api_base_url ?>purchase-medicine/medicineBatchDetails',
                                type: 'POST',
                                data: medicinesJson,
                                contentType: 'application/json',
                                success: function(response) {
                                    let message = response.message || 'Successfully saved';
                                    successMsg(message);
                                    location.reload();
                                },
                                error: function(xhr) {
                            ...
                            errorMsg('Failed to get supplier_bill_basic_id');
                        }
                    },
                    error: function(xhr) {
                        errorMsg('Error occurred');
...
<script>
    ...
    function addTotal() {
        ...
        var hasValue = Array.from(sale_price).some(inp => inp.value.trim() !== '' && parseFloat(inp.value) > 0);
        if (!hasValue) {
            errorMsg("Add atleast one Medicine");
            return false;
        }
...
<script type="text/javascript">
    function delete_bill(id) {
        if (confirm('<?php echo $this->lang->line('delete_confirm'); ?>')) {
            $.ajax({
                url: '<?= $api_base_url ?>purchase-medicine/' + id + '?hospital_id=<?= $data['hospital_id'] ?>',
                type: 'DELETE',
                success: function(res) {
