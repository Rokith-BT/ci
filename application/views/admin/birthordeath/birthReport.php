                        ...
                        <div class="box-tools addmeeting box-tools-md">
                            ...
                            ?>
                                <a data-toggle="modal" onclick="holdModal('myModal')"
                                    class="btn btn-primary btn-sm birthrecord"><i class="fa fa-plus"></i>
                                    <?php echo $this->lang->line('add_birth_record'); ?></a>
                            <?php } ?>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <table class="table table-striped table-bordered table-hover ajaxlist" cellspacing="0"
                            width="100%" data-export-title="<?php echo $this->lang->line('birth_record'); ?>">
                            <thead>
                                <tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('child_name'); ?></label><small class="req">
                                        *</small>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('weight'); ?></label> <small
                                        class="req">*</small>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div><input class="filestyle form-control" type='file' name='child_img'
                                            id="child_img" size='20' data-height="26" />
                                    </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="birth_date" name="birth_date" placeholder="" type="text"
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for=""><?php echo $this->lang->line('mother_name'); ?> </label><small
                                        class="req"> *</small>
                                    <div>
                                        <input type="text" class="form-control" name="mother" id="mother" readonly="">
                                        <input type="hidden" id="mother_name" name="mother_name" value=""
                                            class="form-control">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div><input class="filestyle form-control" type='file' name='first_img'
                                            id="first_img" size='20' data-height="26" />
                                    </div>
                                    <span class="text-danger"><?php echo form_error('file'); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div><input class="filestyle form-control" type='file' name='second_img'
                                            id="second_img" size='20' data-height="26" />
                                    </div>
                                    <span class="text-danger"><?php echo form_error('file'); ?></span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="birth_report" id="birth_report"
                                        class="form-control"><?php echo set_value('birth_report'); ?></textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div><input class="filestyle form-control" type='file' name='document' id="document"
                        ...
                        <table class="table mb0 table-striped table-bordered">
                            ...
                            <tr>
                                <td class="">
                                    ...
                                    ?>
                                    <div class="childimg">
                                        <img class="" src="<?php echo base_url() . $file . img_time() ?>" id="image"
                                ...
                                <td class="">
                                    ...
                                    $file = "uploads/patient_images/no_image.png";
                                    ?>
                                    <div class="childimg"><img class=""
                                            src="<?php echo base_url() . $file . img_time() ?>" id="imagem"
                                ...
                                <td class="">
                                    ...
                                    ?>
                                    <div class="childimg"><img class=""
                                            src="<?php echo base_url() . $file . img_time() ?>" id="imagef"
                                            alt="User profile picture"></div>
                ...
                <div class="scroll-area">
                    <div class="modal-body pt0 pb0">
                        <div class="row">
                            ...
                            <input type="hidden" id="echild_pic">
                            <input type="hidden" id="emother_pic">
                            <input type="hidden" id="efather_pic">
                            <input type="hidden" id="edocument">

                            <div class="col-md-3">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('child_name'); ?></label><small class="req">
                                        *</small>
                                    <input type="text" value="<?php echo set_value('child_name'); ?>" name="child_name"
                                        id="echild_name" class="form-control">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('weight'); ?></label><small class="req">
                                        *</small>
                                    <input type="text" value="<?php echo set_value('weight'); ?>" name="weight"
                                        id="eweight" class="form-control">
                                    <span class="text-danger"><?php echo form_error('weight'); ?></span>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input class="filestyle form-control" type='file' name='child_img' id="echild_img" value="<?php echo set_value('child_pic'); ?>" size='20' data-height="26" />
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('birth_date'); ?></label>
                                    <small class="req">*</small>
                                    <input value="<?php echo set_value('birth_date'); ?>" id="ebirth_date"
                                        name="birth_date" placeholder="" type="text" class="form-control datetime" />
                                    <span class="text-danger"><?php echo form_error('birth_date'); ?></span>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('phone'); ?></label>
                                    <input type="text" value="<?php echo set_value('contact'); ?>" name="contact"
                                        id="econtact" class="form-control">
                                    <span class="text-danger"><?php echo form_error('contact'); ?></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo set_value('address'); ?>" name="address"
                                        id="eaddress" class="form-control">
                                    <span class="text-danger"><?php echo form_error('address'); ?></span>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line("case_id"); ?></label>
                                    <input type="text" onchange="case_reference()" name="case_id"
                                        value="<?php echo set_value('case_id'); ?>" id="ecase_id" class="form-control">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('mother_name'); ?></label><small class="req">
                                        *</small>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div><input class="filestyle form-control" type='file' name='mother_pic'
                                            id="emother_pic1" value="<?php echo set_value('mother_pic'); ?>" size='20'
                                            data-height="26" />
                                    </div>
                                    <span class="text-danger"><?php echo form_error('file'); ?></span>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo set_value('father_name'); ?>"
                                        name="father_name" id="efather_name" class="form-control">
                                    <span class="text-danger"><?php echo form_error('father_name'); ?></span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div><input class="filestyle form-control" type='file' name='father_pic1'
                                            id="efather_pic1" value="<?php echo set_value('father_pic'); ?>" size='20'
                                            data-height="26" />
                                    </div>
                                    <span class="text-danger"><?php echo form_error('file'); ?></span>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="email"><?php echo $this->lang->line('report'); ?></label>
                                    <textarea name="birth_report" id="ebirth_report"
                                        class="form-control"><?php echo set_value('birth_report'); ?></textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div><input class="filestyle form-control" type='file' name='document' id="document1"
                                            value="<?php echo set_value('document'); ?>" size='20' data-height="26" />
                                    </div>
                                    <span class="text-danger"><?php echo form_error('file'); ?></span>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#formadd").on('submit', function(e) {
            ...
            var requiredFields = [{
                    field: "child_name",
                    pattern: /^[a-zA-Z\s]+$/,
                    error: "Child name must only contain letters and spaces"
                },
                {
                    field: "gender",
                ...
                },
                {
                    field: "case_id",
                    pattern: /^\d+$/,
                    error: "Case ID must be a number"
                },
                {
                    field: "mother_name",                   
                    error: "Mother name must only contain letters and spaces"
                }
            ];
            ...
            requiredFields.forEach(function(field) {
                if (!formObject[field.field]) {
                    errorMessages.push(field.error); // Field is empty
                } else if (field.pattern && !field.pattern.test(formObject[field.field])) {
                    errorMessages.push(field.error); // Field doesn't match the pattern
                }
            });

            if (errorMessages.length > 0) {
                errorMsg(errorMessages.join(', ')); // Show all errors in one message
                return;
            }


            var finalData = {
                child_name: formObject.child_name || "",
                child_pic: "",
                gender: formObject.gender || "",
                birth_date: formObject.birth_date ? formatDate(formObject.birth_date) : "2024-09-24",
                weight: formObject.weight || "",
                patient_id: $('#mother_name').val(),
                case_reference_id: $('#case_id').val(),
                contact: formObject.contact || "",
                mother_pic: "",
                father_name: formObject.father_name || "",
                father_pic: "",
                birth_report: formObject.birth_report || "",
                document: "",
                address: formObject.address || "",
                hospital_id: <?= $data['hospital_id'] ?>
            };

            function uploadFileSequentially(field, file, callback) {
            ...
            function startFileUploads() {
                if (formData.get('child_img')) {
                    uploadFileSequentially('child_img', formData.get('child_img'), function(childPicUrl) {
                        finalData.child_pic = childPicUrl;
                        if (formData.get('first_img')) {
                            uploadFileSequentially('first_img', formData.get('first_img'), function(motherPicUrl) {
                                finalData.mother_pic = motherPicUrl;
                                if (formData.get('second_img')) {
                                    uploadFileSequentially('second_img', formData.get('second_img'), function(fatherPicUrl) {
                                        finalData.father_pic = fatherPicUrl;
                                        if (formData.get('document')) {
                                            uploadFileSequentially('document', formData.get('document'), function(documentUrl) {
                                                finalData.document = documentUrl;
            ...
            function sendFinalData(data) {
                $.ajax({
                    url: '<?= $api_base_url ?>php-records/birth',
                    type: 'POST',
    ...
    $(document).ready(function(e) {
        $("#formedit").on('submit', function(e) {
            ...
            var formData = new FormData(this);
            var formObject = {};
            formObject.child_name = formData.get("child_name");
            formObject.gender = formData.get("gender");
            formObject.birth_date = formatDate(formData.get("birth_date"));
            formObject.weight = formData.get("weight");
            formObject.patient_id = $('#mother_name').val();
            formObject.case_reference_id = formData.get("case_id");
            formObject.contact = formData.get("contact");
            formObject.birth_report = formData.get("birth_report");
            formObject.address = formData.get("address");
            formObject.father_name = formData.get("father_name");
            formObject.hospital_id = <?= $data['hospital_id'] ?>;

            let child_pic, mother_pic, father_pic, document;

            let old_child_img = $('#echild_img').val();
            let old_mother_pic = $('#emother_pic1').val();
            let old_father_pic = $('#efather_pic1').val();
            let old_document = $('#document1').val();
            uploadFile('echild_img', old_child_img, function(url) {
                child_pic = url;
                uploadFile('emother_pic1', old_mother_pic, function(url) {
                    mother_pic = url;
                    uploadFile('efather_pic1', old_father_pic, function(url) {
                        father_pic = url;
                        uploadFile('document1', old_document, function(url) {
                            document = url;
                            submitForm(formObject, child_pic, mother_pic, father_pic, document);
                        });
                    });
                });
            });
        ...
        function uploadFile(fieldId, oldFilePath, callback) {
            var fileInput = $("#" + fieldId);
            if (fileInput.length > 0 && fileInput[0].files.length > 0) {
                var fileUploadData = new FormData();
                fileUploadData.append('file', fileInput[0].files[0]);
                ...
                $.ajax({
                    ...
                    processData: false,
                    success: function(response) {
                        callback(response.data || oldFilePath);
                    },
                    error: function(xhr, status, error) {
                        console.error("File upload error for " + fieldId + ":", error);
                        callback(oldFilePath);
                    }
                });
            } else {
                if (fieldId === 'echild_img') {
                    callback(oldFilePath || $('#echild_pic').val());
                } else if (fieldId === 'emother_pic1') {
                    callback(oldFilePath || $('#emother_pic').val());
                } else if (fieldId === 'efather_pic1') {
                    callback(oldFilePath || $('#efather_pic').val());
                } else if (fieldId === 'document1') {
                    callback(oldFilePath || $('#edocument').val());
                }
            }
        }

        function submitForm(formObject, child_pic, mother_pic, father_pic, document) {
            let editid = $('#eid').val();
            formObject.child_pic = child_pic;
            formObject.mother_pic = mother_pic;
            formObject.father_pic = father_pic;
            formObject.document = document;
            console.log(JSON.stringify(formObject));

            $.ajax({
                url: '<?= $api_base_url ?>php-records/birth/' + editid,
                type: 'PATCH',
    ...
    function viewDetail(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                loadImage(data.child_pic, "#image", 'default_child_image.png');
                loadImage(data.mother_pic, "#imagem", 'default_mother_image.png');
                loadImage(data.father_pic, "#imagef", 'default_father_image.png');
                loadImage(data.document, "#document_image", 'default_document.png');


                var table_html = '';
                $.each(data.field_data, function(i, obj) {
                    var field_value = obj.field_value ? obj.field_value : "";
                    var name = obj.name;
                ...
                $('#edit_delete').html(`
                <?php if ($this->rbac->hasPrivilege('birth_record', 'can_view')) { ?>
                    <a href='#' data-toggle='tooltip' onclick='printData(${id})' data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a>
                <?php } ?>
                <?php if ($this->rbac->hasPrivilege('birth_record', 'can_edit')) { ?>
                    <a href='#' onclick='getRecord(${id})' data-toggle='tooltip' data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a>
                <?php } ?>
                <?php if ($this->rbac->hasPrivilege('birth_record', 'can_delete')) { ?>
                    <a onclick='delete_bill(${id})' href='#' data-toggle='tooltip' data-original-title='<?php echo $this->lang->line('delete'); ?>'><i class='fa fa-trash'></i></a>
                <?php } ?>
            `);

                if (data.document) {
                    $('#download_document').html(`
                    <a href='#' onclick='downloadDocument("${data.document}")' data-toggle='tooltip' data-original-title='<?php echo $this->lang->line('download'); ?>'>
    ...
    function loadImage(file, selector, defaultImg) {
        if (file) {
            $.ajax({
    ...
    function downloadDocument(file) {
        $.ajax({
            ...
            success: function(decryptResponse) {
                let base64File = "data:application/octet-stream;base64," + decryptResponse;
    ...
    function getRecord(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#echild_pic').val(data.child_pic);
                $('#emother_pic').val(data.mother_pic);
                $('#efather_pic').val(data.father_pic);
                $('#edocument').val(data.document);

                // Set selected value for gender
                $('#egender').val(data.gender); // This sets the selected value of the dropdown
    ...
    function delete_bill(id) {
        if (confirm('<?php echo $this->lang->line('delete_confirm'); ?>')) {
            $.ajax({
                url: '<?= $api_base_url ?>php-records/birth/' + id,
                type: 'DELETE',
                dataType: 'json',
                data: {
                    "hospital_id": <?= $data['hospital_id'] ?>
