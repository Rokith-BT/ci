    ...
    ?>" class="img-responsive" style="height:100px; width: 100%;">
                    ...
                    <table class="" cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            ...
                            $child_pic = $result['child_pic'];

                            if ($child_pic !== $picdemo) {
                                ...
                                if ($response !== false) {        
                                    ...
                                    ?>
                                    <img style="height: 60px;" src="<?php echo $base64Image; ?>" id="child_image" alt="User profile picture">
                                    <?php
                                } else {        
                                    ?>
                                    <img style="height: 60px;" src="<?php echo base_url() . $picdemo; ?>" id="child_image" alt="User profile picture">
                                    <?php
                                }
                            } else {    
                                ?>
