        ...
        <div class="modal-content modal-media-content">
            ...
            <div class="scroll-area">
                <div class="modal-body pt0 pb0">
                    <div class="row ptt10">
                        <form id="form1" name="itemstockform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.btn-ok', function() {
        ...
        $.ajax({
            url: "<?= $api_base_url ?>php-inventory/item-issue/" + item_issue_id,
            type: "PATCH",
            data: {
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#form1').on('submit', function(e) {
            ...
            var finalObject = {
                "issue_quantity": parseInt(formObject.quantity),
                "issue_note": formObject.note,
                "return_date": formObject.return_date ? formatDate(formObject.return_date) : null,
                "issue_date": formatDate(formObject.issue_date),
                "issued_by": formObject.issue_by,
                "issue_role_id": parseInt(formObject.account_type),
                "issue_to_staff_id": parseInt(formObject.issue_to),
                "item_category_id": parseInt(formObject.item_category_id),
                "item_id": parseInt(formObject.item_id),
                "hospital_id": <?= $data['hospital_id'] ?>
            };

            $.ajax({
                url: '<?= $api_base_url ?>php-inventory/item-issue',
                type: "POST",
        ...
        function validateForm() {
            const requiredFields = ['account_type', 'issue_to', 'issue_by', 'issue_date', 'item_category_id', 'item_id', 'quantity'];
            let isValid = true;
    ...
    function delete_record(id) {
        if (confirm('<?php echo $this->lang->line('delete_confirm') ?>')) {
            $.ajax({
                url: '<?= $api_base_url ?>php-inventory/item-issue/' + id + '?hospital_id=<?= $data['hospital_id'] ?>',
                type: 'DELETE',
                dataType: 'json',
                contentType: 'application/json',
