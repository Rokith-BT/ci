...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="item_category_id" name="item_category_id" class="form-control">
                                        ...
                                        <?php foreach ($itemcatlist as $item_category) { ?>
                                            <option value="<?php echo $item_category['id']; ?>" <?php echo (set_value('item_category_id', $item['item_category_id']) == $item_category['id']) ? "selected" : ""; ?>><?php echo $item_category['item_category']; ?></option>
                                        <?php } ?>
                                    </select>
            ...
            <div class="col-md-<?php echo ($this->rbac->hasPrivilege('item', 'can_add') || $this->rbac->hasPrivilege('item', 'can_edit')) ? "8" : "12"; ?>">
                                            ...
                                            <tr>
                                                <td class="mailbox-name">
                                                    ...
                                                    <div class="fee_detail_popover" style="display: none">
                                                        <?php echo $items['description'] ? "<p class='text text-info'>{$items['description']}</p>" : "<p class='text text-danger'>{$this->lang->line('no_description')}</p>"; ?>
                                                    </div>
                                                </td>
