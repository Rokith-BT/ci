            ...
            <div class="col-lg-3 col-md-4 col-sm-12">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        $picdemo = base_url() . "uploads/patient_images/no_image.png";
                        $child_pic = $result['image'];

                        if ($child_pic && $child_pic !== $picdemo) {
                        ...
                        ?>
                        <img class="profile-user-img img-responsive img-circle" src="<?php echo $base64Image; ?>" alt="User profile picture">
                        <h3 class="profile-username text-center"><?php echo $result['patient_name']; ?></h3>
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('patient_id'); ?></b>
                                <a class="pull-right text-aqua"><?php echo !empty(trim($result['id'])) ? trim($result['id']) : '-'; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('gender'); ?></b>
                                <a class="pull-right text-aqua"><?php echo !empty(trim($result['gender'])) ? trim($result['gender']) : '-'; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('marital_status'); ?></b>
                                <a class="pull-right text-aqua"><?php echo !empty(trim($result['marital_status'])) ? trim($result['marital_status']) : '-'; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('phone'); ?></b>
                                <a class="pull-right text-aqua"><?php echo !empty(trim($result['mobileno'])) ? trim($result['mobileno']) : '-'; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('email'); ?></b>
                                <a class="pull-right text-aqua"><?php echo !empty(trim($result['email'])) ? trim($result['email']) : '-'; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('address'); ?></b>
                                <a class="pull-right text-aqua"><?php echo !empty(trim($result['address'])) ? trim($result['address']) : '-'; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('age'); ?></b>
                                <a class="pull-right text-aqua"><?php
                                                                $age = trim($this->customlib->getPatientAge($result['age'], $result['month'], $result['day']));
                                                                echo !empty($age) ? $age : '-';
                                                                ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('guardian_name'); ?></b>
                                <a class="pull-right text-aqua"><?php echo !empty(trim($result['guardian_name'])) ? trim($result['guardian_name']) : '-'; ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-9 col-md-8 col-sm-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        ?>
                            <li class="active"><a href="#activity" data-toggle="tab" aria-expanded="true"><i
                        ...
                        <?php if ($this->rbac->hasPrivilege('revisit', 'can_view')) { ?>
                            <div class="tab-pane active" id="activity">
                                    ...
                                    <?php if ($this->rbac->hasPrivilege('revisit', 'can_add')) { ?>
                                        ...
                                        <a href="#" onclick="getRevisitRecord('<?php echo $opd_details_id['opdid'] ?>')"
                                            class="btn btn-primary btn-sm revisitpatient" data-toggle="modal" title=""><i
                                                class="fas fa-exchange-alt"></i> <?php echo $this->lang->line('revisit'); ?>
                                        </a>
                                    <?php } ?>
                                </div><!--./impbtnview20-->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover ajaxlistvisit"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2 col-xs-4">
                                            <div class="form-group">
                                                ...
                                                <input id="edit_height" name="height" type="text"
                                                    class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-sm-2 col-xs-4">
                                            <div class="form-group">
                                                ...
                                                <input id="edit_weight" name="weight" type="text"
                                                    class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-sm-2 col-xs-4">
                                            <div class="form-group">
                                                ...
                                                <input name="bp" type="text" name="bp" class="form-control"
                                                    id="edit_bp" />
                                            </div>
                                        </div>
                                        <div class="col-sm-2 col-xs-4">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="appointment_date" class="form-control datetime"
                                                    id="appointmentdate" placeholder="" type="text"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('amount') . " (" . $currency_symbol . ")" ?></label><small
                                                    ...
                                                    id="edit_visit_payment" class="form-control" value="">
                ...
                <div class="modalicon">
                    <div id='edit_delete'>
                        <?php if ($this->rbac->hasPrivilege('revisit', 'can_edit')) { ?>
                            ...
                            <a href="#" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>"><i
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        ...
                                        <div class="row ptt10" id="patientDetails">
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                ...
                                                <input type="hidden" name="revisit_opd_details_id"
                                                    id="revisit_opd_details_id">
                                                <ul class="singlelist">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-3">
                                                <div class="pull-right">
                                                    ...
                                                    if ($child_pic && $child_pic !== $picdemo) {
                                                        ...
                                                        if ($httpCode == 200 && $response !== false && !empty(trim($response))) {
                                                            $base64Image = "data:image/png;base64," . trim($response);
                                                        } else {
                                                            $base64Image = base_url() . $picdemo;  // Fallback to default image
                                                        }
                                                    } else {
                                                        $base64Image = base_url() . $picdemo;
                                                    }
                                                    ?>
                    ...
                    <div class="pull-right">
                        <button type="submit" name="save_print" value="save_print"
                            data-loading-text="<?php echo $this->lang->line('processing'); ?>" class="btn btn-info"><i
                                class="fa fa-check-circle"></i> <?php echo $this->lang->line('save_print'); ?>
                        </button>
...
<div class="modal fade" id="moveIPDModal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog pup100 modalfullmobile" role="document">
        <form action="<?php echo site_url('admin/patient/moveopd') ?>" id="form_confirm-move" method="POST"
            ...
            <div class="modal-content modal-media-content">
                ...
                <div class="modal-footer sticky-footer">
                    ...
                    <button type="submit" data-loading-text="<?php echo $this->lang->line('processing'); ?>"
                        class="btn btn-info pull-right btn-ok"><i class="fa fa-check-circle"></i>
...
<script type="text/javascript">
    ...
    function delete_record(opdid) {
        if (confirm(<?php echo "'" . $this->lang->line('delete_confirm') . "'"; ?>)) {
            $.ajax({
                url: '<?= $api_base_url ?>opd-out-patient/' + opdid + '?hos_id=<?= $data['hospital_id'] ?>',
                type: "DELETE",
                success: function(data) {
    ...
    $(document).ready(function(e) {
        $("#formedit").on('submit', (function(e) {
            ...
            var formattedData = {
                opd_details_id: formData.get("visit_transaction_id"),
                bp: formData.get("bp"),
                ...
                known_allergies: formData.get("known_allergies"),
                note: formData.get("note"),
                appointment_date: formatDateToRequiredFormat(formData.get("appointment_date")),
                case_type: formData.get("case") || "General",
                casualty: formData.get("casualty"),
                patient_old: formData.get("old_patient"),
                symptoms_type: formData.get("symptoms_type"),
                symptoms: formData.get("symptoms"),
                cons_doctor: formData.get("consultant_doctor"),
                refference: formData.get("refference"),
                payment_mode: formData.get("payment_mode"),
                payment_date: formatDateTimeToRequiredFormat(formData.get("payment_date")),
                amount: formData.get("amount"),
                Hospital_id: <?= $data['hospital_id'] ?>,
                received_by_name:'<?=$data['username'] ?>',
            };
            if (formData.get("organisation") != 0) {
                organisation_id = formData.get("organisation");
            }
            ...
            function formatDateTimeToRequiredFormat(dateString) {
                var dateParts = dateString.split(' ');
                var date = dateParts[0].split('/');
                ...
                var formattedTime = `${hours.toString().padStart(2, '0')}:${timeParts[1]}:00`;
                var formattedDateTime = `${date[2]}-${date[0]}-${date[1]} ${formattedTime}`;
                return formattedDateTime;
            }
            var editid = $("#edit_opdid").val();
            $.ajax({
                url: '<?= $api_base_url ?>opd-out-patient/' + editid,
                type: "PATCH",
                data: JSON.stringify(formattedData),
                dataType: 'json',
                contentType: 'application/json',
                success: function(response) {
                    let message = response[0].messege;
                    successMsg(message);
                    window.location.reload(true);
...
<script type="text/javascript">
    ...
    $(document).ready(function(e) {
        ...
        $("#formrevisit").on('submit', function(e) {
            ...
            var formData = new FormData(this);
            var errors = [];
            if (!formData.get("consultant_doctor")) errors.push("Consultant doctor is required.");
            if (!formData.get("charge_id")) errors.push("Charge is required.");
            if (!$('#apply_amount').val()) errors.push("Applied Charge is required.");
            if (!formData.get("amount")) errors.push("Amount is required.");
            if (errors.length > 0) {
                errorMsg(errors.join("<br>"));
                return;
            }
            var mappedObject = {
                "opd_details_id": $('#revisit_opd_details_id').val() || "",
                "cons_doctor": formData.get("consultant_doctor") || "",
                "case_type": formData.get("charge_category") || "",
                "appointment_date": formatAppointmentDate(formData.get("appointment_date")) || "",
                "patient_old": formData.get("old_patient") || "",
                "casualty": formData.get("casualty") || "",
                "refference": formData.get("refference") || "",
                "date": formatDate(formData.get("appointment_date")) || "",
                "note": formData.get("note") || "",
                "payment_mode": (formData.get("payment_mode") || "").toLowerCase(),
                "generated_by": <?= $data['id'] ?> || "",
                "live_consult": formData.get("live_consult") || "",
                "can_delete": "yes",
                "payment_date": currentDate || "",
                "time": currentTime || "",
                "standard_charge": parseFloat(formData.get("standard_charge")) || 0,
                "charge_id": formData.get("charge_id") || "",
                "tpa_charge": 0.00,
                "tax": $('#percentage').val() || "",
                "apply_charge": parseFloat(formData.get("apply_amount")) || 0,
            ...
            var clickedButton = $("form#formrevisit button[type=submit][clicked='true']");
            clickedButton.prop("disabled", true).text("Processing...");
            $.ajax({
                url: '<?= $api_base_url ?>internal-opd-overview-visits',
                type: "POST",
                data: JSON.stringify(mappedObject),
                contentType: 'application/json',
                dataType: 'json',
                success: function(data) {
                ...
                complete: function() {
                    setTimeout(function() {
                        clickedButton.prop("disabled", false).text(clickedButton.attr("name") === "save_print" ? "Save & Print" : "Save");
                    }, 3000);
                }
            });
        });
    ...
    function getRevisitRecord(opdid) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(data) {
                // console.log(JSON.stringify(data.opd_details_id,null,2)); 
                $("#revisit_opd_details_id").val(data.opd_details_id);
