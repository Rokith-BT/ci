                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item listnoback">
                                ...
                                <a class="pull-right text-aqua"><?php echo trim($result['patient_id']) ?: ""; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('phone'); ?></b>
                                <a class="pull-right text-aqua"><?php echo trim($result['mobileno']) ?: ""; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('email'); ?></b>
                                <a class="pull-right text-aqua"><?php echo trim($result['email']) ?: ""; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('blood_group'); ?></b>
                                <a class="pull-right text-aqua"><?php echo trim($result['blood_group_name']) ?: ""; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('age'); ?></b>
                                <a class="pull-right text-aqua">
                                    <?php echo trim($this->customlib->getPatientAge($result['age'], $result['month'], $result['day'])) ?: ""; ?>
                                </a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('opd_no'); ?></b>
                                <a class="pull-right text-aqua"><?php echo trim($opd_prefix . $result['id']) ?: ""; ?></a>
                            </li>
                            <?php if (!$is_discharge) { ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('discharged'); ?></b>
                                    <a class="pull-right text-aqua"><?php echo $this->lang->line('yes'); ?></a>
                                </li>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('discharge_date'); ?></b>
                                    <a class="pull-right text-aqua">
                                        <?php echo trim($this->customlib->YYYYMMDDHisTodateFormat($result['discharge_date'], $this->customlib->getHospitalTimeFormat())) ?: ""; ?>
                                    </a>
                                </li>
                            <?php } ?>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('consultant'); ?></b>
                                <a class="pull-right text-aqua"><?php echo trim($result['name'] . " " . $result["surname"]) ?: ""; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('case'); ?></b>
                                <a class="pull-right text-aqua"><?php echo trim($result['case_type']) ?: ""; ?></a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane active" id="activity">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                                ...
                                                <th class="text-center"><?php echo $this->lang->line('appointment_date'); ?></th>
                                                ...
                                                ?>
                                                <th class="text-center text-right noExport"><?php echo $this->lang->line('action') ?></th>
                                            </thead>
                                        <tbody>
                                        </tbody>
                                    </table>
...
<script type="text/javascript">
    ...
    $(document).ready(function(e) {
        $("#formedit").on('submit', (function(e) {
            ...
            let visit_id = $('#visitid').val();
            $.ajax({
                url: '<?= $api_base_url ?>internal-opd-overview-visits/' + visit_id,
                type: "PATCH",
    ...
    function delete_timeline(id) {
        ...
        if (confirm('<?php echo $this->lang->line("delete_confirm"); ?>')) {
            $.ajax({
                url: '<?= $api_base_url ?>internal-opd-timeline/' + id + '?hosId=<?= $data['hospital_id'] ?>',
                type: 'Delete',
                success: function(response) {
                ...
                error: function() {
                    alert("An error occurred while trying to delete the timeline.");
                }
            });
        }
    }
...
<script type="text/javascript">
    ...
    function get_Charges(orgid) { //alert(orgid);
