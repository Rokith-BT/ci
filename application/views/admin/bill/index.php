            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <?php if ($_GET["case"] == "patient_id") { ?>
                        <h3 class="box-title"><?php echo $this->lang->line('patient'); ?> Detials</h3>
                        <?php } else { ?>
                        <h3 class="box-title"><?php echo $this->lang->line('opd_ipd_billing'); ?></h3>
                        <?php } ?>
                        <div class="box-tools pull-right box-tools-md">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu s-bill-list">
                                    <h3 class="s-bill-title"><?php echo $this->lang->line('single_module_billing'); ?>
                                    </h3>
                                    <?php if ($this->rbac->hasPrivilege('appointment_billing', 'can_view')) { ?>
                                    <li><a href="<?php echo base_url('admin/bill/appointment'); ?>"><i
                                                class="fa fa-calendar-check-o"></i><?php echo $this->lang->line('appointment'); ?></a>
                                    </li>
                                    <?php }
                                    if ($this->rbac->hasPrivilege('opd_billing', 'can_view')) { ?>
                                    <li><a href="<?php echo base_url('admin/bill/opd'); ?>"><i
                                                class="fas fa-stethoscope"></i>
                                            <?php echo $this->lang->line('opd'); ?></a></li>
                                    <?php }
                                    if ($this->rbac->hasPrivilege('pathology_billing', 'can_view')) { ?>
                                    <li><a href="<?php echo base_url('admin/bill/pathology'); ?>"><i
                                                class="fas fa-flask"></i>
                                            <?php echo $this->lang->line('pathology'); ?></a>
                                    </li>
                                    <?php }
                                    if ($this->rbac->hasPrivilege('radiology_billing', 'can_view')) { ?>
                                    <li><a href="<?php echo base_url('admin/bill/radiology'); ?>"><i
                                                class="fas fa-microscope"></i>
                                            <?php echo $this->lang->line('radiology'); ?></a>
                                    </li>
                                    <?php }
                                    if ($this->rbac->hasPrivilege('blood_bank_billing', 'can_view')) { ?>
                                    <li><a href="<?php echo base_url('admin/bill/issueblood'); ?>"><i
                                                class="fas fa-tint"></i>
                                            <?php echo $this->lang->line('blood_issue'); ?></a>
                                    </li>
                                    <?php }
                                    if ($this->rbac->hasPrivilege('blood_bank_billing', 'can_view')) { ?>
                                    <li><a href="<?php echo base_url('admin/bill/issuecomponent'); ?>"><i
                                                class="fas fa-burn"></i>
                                            <?php echo $this->lang->line('blood_component_issue'); ?></a>
                                    </li>
                                    <?php } ?>
                                </ul>
                            </div>
                        ...
                        <form id="formsearch" accept-charset="utf-8" method="post" class="form-inline align-top"
                            ...
                            <div class="form-group">
                                <div class="">
                                    ...
                                    <input type="text" name="case_id" class="form-control" id="case_id"
                    ...
                    <div class="nav-tabs-custom border0">
                        <ul class="nav nav-tabs navlistscroll">
                            ...
                            <li class="active">
                                <a href="#opd" data-toggle="tab" aria-expanded="true" onclick="load_opd_data()">
                                    <?php echo $this->lang->line('opd') ?>
                                </a>
                            </li>
                            <?php } ?>
                            <?php } elseif ($case == 'ipd_id') { ?>
                            <!-- <li class="active">
                                    <a href="#opd" data-toggle="tab" aria-expanded="true" onclick="load_opd_data()">
                                        <?php echo $this->lang->line('opd') ?>
                                    </a>
                            ...
                            <li class="active">
                                <a onclick="load_ipd_data()" href="#ipd" data-toggle="tab" aria-expanded="true">
                            ...
                            <!-- <?php if ($this->rbac->hasPrivilege('pharmacy_billing', 'can_view')) { ?>
                                    <li>
                                        <a href="#pharmacy" onclick="load_pharmacy_data()" data-toggle="tab" aria-expanded="true">
                                ...
                                <?php if ($this->rbac->hasPrivilege('pathology_billing', 'can_view')) { ?>
                                    <li>
                                        <a href="#pathology" onclick="load_pathology_data()" data-toggle="tab" aria-expanded="true">
                                            <?php echo $this->lang->line('pathology') ?>
                                        </a>
                                    </li>
                                <?php } ?>
                                <?php if ($this->rbac->hasPrivilege('radiology_billing', 'can_view')) { ?>
                                    <li>
                                        <a href="#radiology" onclick="load_radiology_data()" data-toggle="tab" aria-expanded="true">
                                            <?php echo $this->lang->line('radiology') ?>
                                        </a>
                                    </li>
                                <?php } ?>
                                <?php if ($this->rbac->hasPrivilege('blood_bank_billing', 'can_view')) { ?>
                                    <li>
                                        <a href="#blood_bank" onclick="load_blood_bank_data()" data-toggle="tab" aria-expanded="true">
                                            <?php echo $this->lang->line('blood_bank') ?>
                                        </a>
                                    </li>
                                <?php } ?>
                                <?php if ($this->rbac->hasPrivilege('ambulance_billing', 'can_view')) { ?>
                                    <li>
                                        <a href="#ambulance" onclick="load_ambulance_data()" data-toggle="tab" aria-expanded="true">
                                            <?php echo $this->lang->line('ambulance') ?>
                                        </a>
                                    </li>
                                <?php } ?> -->
                            <?php } ?>
                        ...
                        <div class="tab-content">
                            <?php if ($this->rbac->hasPrivilege('opd_billing', 'can_view')) { ?>
                            <div class="tab-pane <?php echo (isset($_GET["case"]) && $_GET["case"] == "opd_id") ? "active" : ""; ?>"
                                id="opd">
                            </div>
                            <?php }
                            ...
                            <!-- end opd -->
                            <!-- start ipd -->
                            <div class="tab-pane <?php echo (isset($_GET["case"]) && $_GET["case"] == "ipd_id") ? "active" : ""; ?>"
                                id="ipd">
                            </div>
                            <?php }
                            ...
                            <div class="tab-pane " id="pharmacy">
                                <div class="">
                                    <table class="table table-striped table-bordered table-hover load_pharmacy"
                                        data-export-title="<?php echo $this->lang->line('pharmacy_bill_details'); ?>">
                                        <thead>
                                            <tr>
                            ...
                            <div class="tab-pane" id="pathology">
                                <div class="">
                                    <table class="table table-striped table-bordered table-hover load_pathology"
                                        data-export-title="<?php echo $this->lang->line('pathology_bill_details'); ?>">
                                        <thead>
                                            <tr>
                                                <th><?php echo $this->lang->line('bill_no'); ?></th>
                            ...
                            <div class="tab-pane " id="radiology">
                                ...
                                <div class="">
                                    <table class="table table-striped table-bordered table-hover load_radiology"
                                        data-export-title="<?php echo $this->lang->line('radiology_bill_details'); ?>">
                                        <thead>
                                            <th><?php echo $this->lang->line('bill_no'); ?></th>
                            ...
                            <div class="tab-pane " id="blood_bank">
                                ...
                                <div class="">
                                    <table class="table table-striped table-bordered table-hover load_blood_bank"
                                        data-export-title="<?php echo $this->lang->line('blood_bank_bill_details'); ?>">
                                        <thead>
                                            <tr>
                                                <th><?php echo $this->lang->line('bill_no'); ?></th>
                            ...
                            <div class="tab-pane " id="ambulance">
                                ...
                                <div class="">
                                    <table class="table table-striped table-bordered table-hover load_ambulance"
                                        data-export-title="<?php echo $this->lang->line('ambulance_bill_details'); ?>">
                                        <thead>
                            ...
                            <div class="modal-content modal-media-content">
                                <div class="modal-header modal-media-header">
                                    <button type="button" class="close" data-toggle="tooltip"
                                        title="<?php echo $this->lang->line('close'); ?>"
                            ...
                            <div class="modal-content modal-media-content">
                                <div class="modal-header modal-media-header">
                                    ...
                                    <h4 class="modal-title">
                                        <?php echo $this->lang->line('bill') . " " . $this->lang->line('details'); ?>
                                    </h4>
                                </div>
                    ...
                    <div class="modal fade" id="addrefundPaymentModal" style="z-index: 1600;" role="dialog"
                        aria-labelledby="follow_up">
                            ...
                            <div class="modal-content modal-media-content">
                                <div class="modal-header modal-media-header">
                                    ...
                                    <h4 class="modal-title" id="modal_title">
                                        <?php echo $this->lang->line('payments'); ?></h4>
                                </div>
                    ...
                    <div class="modal fade" style="z-index: 1400;" id="generate_bill" role="dialog"
                        aria-labelledby="follow_up">
                        <div class="modal-dialog modal-mid modal-lg" role="document">
                            <div class="modal-content modal-media-content">
                                <div class="modal-header modal-media-header">
                    ...
                    <div class="modal fade" id="myPaymentModal" tabindex="-1" role="dialog"
                                ...
                                <form id="add_payment" accept-charset="utf-8" method="post" class="ptt10">
                                    <div class="modal-body pb0 pt0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label><?php echo $this->lang->line('date'); ?></label><small
                                                        class="req"> *</small>
                                                    <input type="text" name="payment_date" id="date"
    ...
    <div class="modal-dialog pup100" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title"><span id="patient_bill_summary"> </span>
                    <?= $this->lang->line("bill_summary"); ?></h4>
            </div>
...
$(document).on('click', '.add_payment', function(e) {
    ...
    var caseid = $(this).data('case-id-opd');
    var balance_amount = $(this).data('balance-amount');
    $('#amount').val(balance_amount);
...
$(document).on('click', '.view_payment', function(e) {
    ...
    var encodedPatientId = pathArray[pathArray.length - 1];
    var patient_id = atob(decodeURIComponent(encodedPatientId));
    var record_id = $(this).data('record-id');
    var caseid = $(this).data('case-id');
    var module_type = $(this).data('module-value');
    var search = "<?php echo isset($_GET['case']) ? $_GET['case'] : ''; ?>";
    ...
    $.ajax({
        ...
        success: function(res) {
            if (res.status == '1') {
                $('#allpayments_print').html(
                    '<a href="javascript:void(0);" class="print_transactions" data-record-id="' +
                    record_id + '" data-toggle="tooltip" title="" data-module-value="' +
                    module_type + '" data-case-id="' + caseid +
                ...
                alert('No payments found or some error occurred.');
            }
        },
        error: function(xhr) {
...
function get_patientdetails(case_id) {
    let search = "<?= $_GET['case'] ?? '' ?>";
    $.ajax({
        url: base_url + 'admin/bill/getDetailsByCaseId/' + case_id + '?search=' + encodeURIComponent(search),
        type: "POST",
        dataType: 'json',
        success: function(data) {
            if (data.status == 1) {
                ...
                errorMsg("<?= $this->lang->line('no_record_found') ?>");
                $('#patient_details').html('');
            }
        },
        error: function() {
            errorMsg("<?= $this->lang->line('error_occurred') ?>");
        }
    });
}
...
function load_opd_data() {
    if (get_case_id() !== 0) {
        let quary = "<?= $_GET["case"] ?>";
        $.ajax({
            url: base_url + 'admin/bill/getopd/' + get_case_id() + "?case=" + quary,
            type: "POST",
            dataType: 'json',
            success: function(data) {
                $('#opd').html(data.page);
...
function load_ipd_data() {
    if (get_case_id() !== 0) {
        let quary = "<?= $_GET["case"] ?>";
        $.ajax({
            url: base_url + 'admin/bill/getipd/' + get_case_id() + "?case=" + quary,
            type: "POST",
            ...
            $(document).ready(function() {
                initDatatable('load_pharmacy', 'admin/bill/getpharmacy/' + get_case_id(), [], [], 100,
                    [{
                            "sWidth": "105px",
                            "aTargets": [-1, -2, -3, -4],
                            'sClass': 'dt-body-right dt-head-right'
                        },
            ...
            $(document).ready(function() {
                initDatatable('load_blood_bank', 'admin/bill/getbloodbank/' + get_case_id(), [], [], 100,
                    [{
                        ...
                        "bSortable": false,
                        "aTargets": [-1, -2, -3],
                        'sClass': 'dt-head-right dt-body-right'
                    }]);
            });
        }(jQuery))
    } else {
...
$(document).on('click', '.view_generate_bill', function() {
    ...
    let encryptedPatientId = urlParts[urlParts.length - 1];
    let patientId = atob(encryptedPatientId);
    $this.button('loading');
    $.ajax({
        ...
        success: function(res) {
            ...
            $('#refund_print').html(
                ' <a href="javascript:void(0);"   class=" generate_bill" data-toggle="tooltip" title="" data-module_type="ipd_opd" data-case_id="' +
                case_id + '"><i class="fa fa-print"></i> </a> ');
...
$(document).on('click', '.print_bill', function() {
    ...
    let search = $(this).data('search-value');
    var $this = $(this);
    $.ajax({
...
$(document).ready(function() {
    $("#add_payment").on('submit', function(e) {
        ...
        if (!dateField.val()) errorMessages.push("Date is required.");
        if (!amountField.val()) errorMessages.push("Amount (INR) is required.");
        else if (isNaN(amountField.val()) || parseFloat(amountField.val()) <= 0) errorMessages.push(
        ...
        var fileInput = form.find('input[name="document"]')[0].files[0];
        ...
        if (module_name == 'ipd') {
            ...
            const encryptedPatientId = segments[segments.length - 1];
            const patientId = atob(encryptedPatientId);
            $.ajax({
                type: "GET",
                url: "<?php echo base_url(); ?>admin/bill/lastopdid",
                data: {
                    "patient_id": patientId,
                    "type": "ipd"
                },
                ...
                success: function(response) {
                    if (response) {
                        let case_reference_id = response.case_reference_id;
                        let opdid = response.ipd_id;
                        jsonData = {
                            "payment_date": formattedDate,
                            "patient_id": $('#bill_patient_id').val(),
                        ...
                        api = '<?= $api_base_url ?>opd-billing/AddIPDPayment';
                        if (paymentMode === "Cheque" && fileInput) {
                            jsonData.cheque_no = form.find('input[name="cheque_no"]').val();
                            var chequeDateInput = form.find('input[name="cheque_date"]')
                                .val();
                            var chequeDate = new Date(chequeDateInput);
                            jsonData.cheque_date = chequeDate.getFullYear() + '-' +
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    jsonData.attachment_name = fileInput.name;
                                    handleOnlinePayment(jsonData, api);
                                },
                                error: function() {
            ...
            if (form.find('input[name="case_reference_id"]').val() == '' && $('#bill_opdid').val() ==
                '') {
                const path = window.location.pathname;
                const segments = path.split('/');
                const encryptedPatientId = segments[segments.length - 1];
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response) {
                            ...
                            api = '<?= $api_base_url ?>opd-billing/AddOPDPayment';
                            if (paymentMode === "Cheque" && fileInput) {
                                jsonData.cheque_no = form.find('input[name="cheque_no"]')
                                    .val();
                                var chequeDateInput = form.find('input[name="cheque_date"]')
                                    .val();
                                var chequeDate = new Date(chequeDateInput);
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        jsonData.attachment = response.data;
                                        jsonData.attachment_name = fileInput
                                            .name;
                                        handleOnlinePayment(jsonData, api);
                                    },
                                    error: function() {
                ...
                let case_reference_id = form.find('input[name="case_reference_id"]').val();
                let opdid = $('#module_id').val();
                jsonData = {
                    "payment_date": formattedDate,
                    "patient_id": $('#bill_patient_id').val(),
                    "case_reference_id": case_reference_id,
    ...
    function handleOnlinePayment(jsonData, api) {
    ...
    function submitForm(data, api) {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response[0]['data '].status === "fail") {
