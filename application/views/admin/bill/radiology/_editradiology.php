...
?>
<input type="hidden" name="radiology_billing_id" id="radiology_billing_id" value="<?php echo $radiology_data->id; ?>">
<input type="hidden" name="ipd_prescription_basic_id" id="ipd_prescription_basic_id" value="<?php echo $radiology_data->ipd_prescription_basic_id; ?>">
<input type="hidden" name="tax_percentage" id="tax_percentage" value="<?php echo $radiology_data->tax_percentage; ?>">
              <div class="row">
                                    ...
                                    foreach ($radiology_data->radiology_report as $report_key => $report_value) {
                                        ...
                                        <tr id="row<?php echo $total_rows; ?>">
                                            <td>
                                                ...
                                                <select class="form-control test_name select2" style="width:100%" onchange="gettestradiodetails(this.value, <?php echo $total_rows; ?>)" name='test_name_<?php echo $total_rows; ?>'>
