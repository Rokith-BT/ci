          ...
          <tbody>
            ...
            foreach ($result->pathology_report as $report_key => $report_value) {
              ...
              <tr>
                ...
                <td class="text-right"><?php echo $currency_symbol . $taxamount . "(" . $report_value->tax_percentage . "%)"; ?>
                </td>
                ...
                <td class="text-right">
                  ...
                  if ($is_bill) { ?>
                    <a href='javascript:void(0)' data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>'
                      data-record-id='<?php echo $report_value->id; ?>' class='btn btn-default btn-xs add_collection'
                      data-toggle='tooltip' title='<?php echo $this->lang->line("add_edit_collection_person"); ?>'><i
                        class='fa fa-user-plus'></i></a>
                    <?php
                    if ($report_value->collection_specialist_staff_employee_id != "") {
                      ?>
                      <a href='javascript:void(0)' data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>'
                        data-record-id='<?php echo $report_value->id; ?>' class='btn btn-default btn-xs add_report'
                        data-toggle='tooltip' title='<?php echo $this->lang->line("add_edit_report"); ?>'><i
                  ...
                  <a href='javascript:void(0)' data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>'
                    data-record-id='<?php echo $report_value->id; ?>' class='btn btn-default btn-xs print_pathology_report'
                    data-toggle='tooltip' title='<?php echo $this->lang->line("print"); ?>'><i
                      class='fa fa-print'></i></a>
                    
                      <?php                     
                       if (!empty($report_value->pathology_report)) {
                        $userdata = $this->session->userdata('hospitaladmin');
                        $accessToken = $userdata['accessToken'] ?? '';
                        $name = $report_value->pathology_report;
