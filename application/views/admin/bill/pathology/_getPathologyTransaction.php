    ...
    <div  class="col-lg-7 col-md-7 col-sm-7">
     <div class="row">
        ...
        <div class="col-lg-5 col-md-5 col-sm-5">
            ...
            <form id="<?php echo $form_id;?>"  accept-charset="utf-8" method="post" enctype="multipart/form-data">
...
<?php
  ...
  <script>
    ...
    var finalData = {
        ...
        pathology_billing_id: parseInt(pathology_billing_id),
        note: formData.get('note'),
        received_by: <?=$data['id']?>,
        amount: parseFloat(formData.get('amount')).toFixed(2),
        payment_mode: formData.get('payment_mode'),
        cheque_no: formData.get('cheque_no') || "",
        cheque_date: formatDate(formData.get('cheque_date')) || "2024-09-11 11:11:11",
        attachment: "new.jpg",
        attachment_name: "new",
        hospital_id: <?=$data['hospital_id']?>
    };  
    // console.log("Final Data as JSON:", JSON.stringify(finalData, null, 2));
    $.ajax({
...
function formatDate(dateString) {
    ...
    const formattedDate = `${year}-${('0' + month).slice(-2)}-${('0' + day).slice(-2)} ${('0' + hour).slice(-2)}:${('0' + minute).slice(-2)}:00`;
