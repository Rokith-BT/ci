            ...
            if ($this->module_lib->hasActive('appointment')) {
                if ($this->rbac->hasPrivilege('opd_income_widget', 'can_view')) {
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-6 col20
                         ">
                        <div class="info-box" title="<?php echo $this->lang->line('appointment_income'); ?>">
                            <a href="<?php echo site_url('admin/appointment/index') ?>">
                                <span class="info-box-icon bg-green"><i class="fas fa-stethoscope"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text"><?php echo $this->lang->line('appointment_income'); ?></span>
                                    <span class="info-box-number"><?php
                                        if (!empty($appointment_income)) {
                                            echo $currency_symbol . $appointment_income;
                                        } else {
                                            echo "0";
                                        }
                                        ?></span>
