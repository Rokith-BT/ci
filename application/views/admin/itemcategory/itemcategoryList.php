        ...
        ?>
                                                ...
                                                <td class="mailbox-date pull-right noExport">
                                                    ...
                                                    <?php }if ($this->rbac->hasPrivilege('item_category', 'can_delete')) {?>
                                                        <a class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordByIdReload('<?php echo $api_base_url; ?>setup-inventory-item-category/<?php echo $category['id']; ?>?Hospital_id=<?php echo $data['hospital_id']; ?>', '<?php echo $this->lang->line('delete_confirm'); ?>')">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="itemcategoryadd"  name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
...
$(document).ready(function() {
    $('#itemcategoryadd').on('submit', function(e) {
        e.preventDefault();        
        var formData = {
        ...
        $.ajax({
            url: '<?=$api_base_url?>setup-inventory-item-category',
            type: 'POST',
            data: formData,            
            beforeSend: function() {
            ...
            successMsg('Item Category add successfully'); 
            location.reload();                
            },
            complete: function() {
...
<script>
    ...
    $(document).ready(function() {
        $('#editformadd').on('submit', function(e) {
            e.preventDefault();        
            var formData = {
                'item_category': $('#itemcategory1').val(),
            ...
            console.log(formData) ;
            $.ajax({
                url: '<?=$api_base_url?>setup-inventory-item-category/' + cat_id ,
                type: 'PATCH',
                data: formData,            
                beforeSend: function() {
                ...
                success: function(response) {               
                successMsg('Item Category Updated successfully'); 
                location.reload();                
                },
                complete: function() {
