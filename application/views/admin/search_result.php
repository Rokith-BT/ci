                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="download_label">
                            <?php echo $this->lang->line('patient') . " " . $this->lang->line('list'); ?></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" data-toggle="modal"
                                            onclick="getpatientData('<?php echo $report['id'] ?>')" data-target=""
                                            class="" title=""><?php echo $report['patient_name'] ?>
                                        </a>
                                    </td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close pt4" data-toggle="tooltip"
                                            ...
                                            <ul class="singlelist">
                                                ...
                                                <li>
                                                    <i class="fas fa-user-secret" data-toggle="tooltip"
                                                        data-placement="top" title="Patient"></i>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="row ptt10">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label
                                                    for="insurance_id"><?php echo $this->lang->line('insurance_id'); ?></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label
                                                    for="validity"><?php echo $this->lang->line('validity'); ?></label>
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.is_active == 'yes') {
                ...
                var link =
                    "<?php if ($this->rbac->hasPrivilege('enabled_disabled', 'can_view')) { ?><a href='#' data-toggle='tooltip'  onclick='patient_active(" +
                    id +
            ...
            $.each(data.field_data, function(i, obj) {
                ...
                var name = obj.name;
                table_html += "<b><span id='vcustom_name'>" + capitalizeFirstLetter(name) +
                    "</span></b> <span id='vcustom_value'>" + field_value + "</span><br>";
            });
