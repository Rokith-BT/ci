                            ...
                            <div class="row">
                                   <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="payment_date" id="date" class="form-control datetime" value="<?= date('Y-m-d H:i:s'); ?>" readonly disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="amount" id="amount" value="<?= $balance_amount; ?>" class="form-control" readonly>
