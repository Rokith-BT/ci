            ...
            <tbody>
                ...
                <tr id="row<?php echo $total_rows;?>">
                    ...
                    <td>
                       ...
                       <button type="button"  class="closebtn delete_row" onclick='deleteparameter(<?php echo $param_value->id;?>)'><i class="fa fa-remove"></i></button>
                   <?php } ?>
                    </td>
                </tr>
            <?php
...
<script>
    function deleteparameter(id){        
                if (confirm('<?php echo $this->lang->line('delete_confirm'); ?>')) {
                    $.ajax({
                        url: '<?=$api_base_url?>radiology-test/deleteRadilogyparameterdetails/'+id+'?hospital_id=<?=$data['hospital_id']?>',
                        type: "DELETE",
                        data: {id: id},
                        dataType: 'json',
