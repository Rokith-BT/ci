                                ...
                                <div class="">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>
                                               <?php echo $this->lang->line('referral_doctor'); ?></label><small class="req"> *</small>
                                            <div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('doctor_name'); ?></label><small class="req"> *</small>
                    ...
                    <div class="col-sm-6">
                        <table class="printablea4">
                            ...
                            <tr>
                                ...
                                <input type="text" placeholder="<?php echo $this->lang->line('discount'); ?>" name="discount_percent" id="discount_percent" oninput="addTotal()" class="form-control discount_percent" style="width: 70%; float: right;font-size: 12px;"/></td>
