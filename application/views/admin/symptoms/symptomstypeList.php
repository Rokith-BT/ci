...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="symptomstypeadd" method="post" accept-charset="utf-8">
...
<script>
    $(document).ready(function() {
        $('#editformadd').on('submit', function(e) {
            e.preventDefault();
            var formData = {
                symptoms_type: $('#symptomstype').val(),
                Hospital_id: <?= $data['hospital_id'] ?>
            };
            let symptoms_id = $('#symptoms_id').val();
            var requiredFields = [{
                field: "symptoms_type",
                pattern: /^[a-zA-Z\s]+$/,
                error: "Symptoms type must only contain letters and spaces"
            }];
            var errorMessages = [];
            ...
            sendAjaxRequest('<?= $api_base_url ?>setup-symptoms-symptoms-type/' + symptoms_id, 'PATCH', formData, function(response) {
...
<script>
    $(document).ready(function() {
        $('#symptomstypeadd').on('submit', function(e) {
            e.preventDefault();
            var formData = {
            ...
            sendAjaxRequest('<?= $api_base_url ?>setup-symptoms-symptoms-type', 'POST', formData, function(response) {
                handleResponse(response);
            });
        });
    });
...
<script>
    ...
    $(document).ready(function() {
        let actionTemplate = `
            ...
            <a class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="delete_recordByIdReload('<?= $api_base_url ?>/setup-symptoms-symptoms-type/key:id?Hospital_id=<?= $data['hospital_id'] ?>', 'Delete Confirm?')" data-original-title="Delete">
        ...
        initializeTable(
            initialData,
            initialDataTotal,
            `${base_url}admin/symptoms/getsymptomstype`,
            '#ajaxlist',
            ['sno', 'symptoms_type', 'action'],
            actionTemplate,
            'id'
        );
    });
