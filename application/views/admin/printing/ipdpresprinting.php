        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form enctype="multipart/form-data" id="printSettingsForm">
                            <input type="hidden" name="id" value="<?php if (!empty($printing_list)) {
                                                                        echo $printing_list[0]['id'];
                                                                    } ?>">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="compose_textarea" name="footer_content" class="form-control" style="height: 250px"><?php if (!empty($printing_list)) {
                                                                                                                                                echo $printing_list[0]['print_footer'];
                                                                                                                                            } ?></textarea>
