                    ...
                    <div class="box-body">
                        <form role="form" enctype="multipart/form-data" id="printSettingsForm" method="post">
                            <input type="hidden" name="id"
                                value="<?php echo !empty($printing_list) ? $printing_list[0]['id'] : ''; ?>">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="old_header_image"
                                            value="<?php if(!empty($printing_list)){ echo $printing_list[0]['print_header'];} ?>">
                                        <input data-default-file="<?php echo $logo_image ?>" type="file"
                                            ...
                                            oninput="validateImage(this)"> <input type="hidden" class="form-control"
                                            name="print_header">
                                        <span class="text-danger"><?php echo form_error('header_image'); ?></span>
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('footer_content'); ?></label>
                                        <textarea id="compose_textarea" name="footer_content" class="form-control"
                                            style="height: 250px"><?php echo !empty($printing_list) ? $printing_list[0]['print_footer'] : ''; ?></textarea>
                                ...
                                <div class="col-lg-12">
                                    <div class="pull-right">
                                        <button type="button" class="btn btn-primary"
                                            id="saveButton"><?php echo $this->lang->line('save'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </form>
