                ...
                <div class="col-md-9 col-sm-9 col-xs-9">
                    ...
                    <ul class="singlelist">
                        <li class="singlelist24bold">
                            <span><?php echo composePatientName($patient['patient_name'], $patient['patient_id']); ?></span>
                        </li>
                        <li>
                            <i class="fas fa-user-secret" data-toggle="tooltip" data-placement="top"
                                title="<?php echo $this->lang->line('guardian'); ?>"></i>
                            <span><?php echo !empty(trim($patient['guardian_name'] ?? '')) ? trim($patient['guardian_name']) : "-"; ?></span>
                        </li>
                    </ul>
                    ...
                    <ul class="multilinelist">
                        <li>
                            ...
                            <span><?php echo !empty(trim($patient['gender'] ?? '')) ? trim($patient['gender']) : "-"; ?></span>
                        </li>
                        <li>
                            <i class="fas fa-tint" data-toggle="tooltip" data-placement="top"
                                title="<?php echo $this->lang->line('blood_group'); ?>"></i>
                            <span><?php echo !empty(trim($patient['blood_group_name'] ?? '')) ? trim($patient['blood_group_name']) : "-"; ?></span>
                        </li>
                        <li>
                            <i class="fas fa-ring" data-toggle="tooltip" data-placement="top"
                                title="<?php echo $this->lang->line('marital_status'); ?>"></i>
                            <span><?php echo !empty(trim($patient['marital_status'] ?? '')) ? trim($patient['marital_status']) : "-"; ?></span>
                        </li>
                    </ul>

                    <ul class="singlelist">
                        <li>
                            <i class="fas fa-hourglass-half" data-toggle="tooltip" data-placement="top"
                                title="<?php echo $this->lang->line('age'); ?>"></i>
                            <span><?php echo !empty(trim($patient['dob'] ?? '')) ? $this->customlib->getAgeBydob(trim($patient['dob'])) : "-"; ?></span>
                        </li>
                        <li>
                            <i class="fa fa-phone-square" data-toggle="tooltip" data-placement="top"
                                title="<?php echo $this->lang->line('phone'); ?>"></i>
                            <span><?php echo !empty(trim($patient['mobileno'] ?? '')) ? trim($patient['mobileno']) : "-"; ?></span>
                        </li>
                        <li>
                            <i class="fa fa-envelope" data-toggle="tooltip" data-placement="top"
                                title="<?php echo $this->lang->line('email'); ?>"></i>
                            <span><?php echo !empty(trim($patient['email'] ?? '')) ? trim($patient['email']) : "-"; ?></span>
                        </li>
                        <li>
                            <i class="fas fa-street-view" data-toggle="tooltip" data-placement="top"
                                title="<?php echo $this->lang->line('address'); ?>"></i>
                            <span><?php echo !empty(trim($patient['address'] ?? '')) ? trim($patient['address']) : "-"; ?></span>
                        </li>
                        <li>
                            <b><?php echo $this->lang->line('any_known_allergies') ?> </b>
                            <span><?php echo !empty(trim($patient['known_allergies'] ?? '')) ? trim($patient['known_allergies']) : "-"; ?></span>
                        </li>
                        <li>
                            <b><?php echo $this->lang->line('remarks') ?> </b>
                            <span><?php echo !empty(trim($patient['note'] ?? '')) ? trim($patient['note']) : "-"; ?></span>
                        </li>
                        <li>
                            <b><?php echo $this->lang->line('tpa_id') ?> </b>
                            <span><?php echo !empty(trim($patient['insurance_id'] ?? '')) ? trim($patient['insurance_id']) : "-"; ?></span>
                        </li>
                        <li>
                            <b><?php echo $this->lang->line('tpa_validity') ?> </b>
                            <span><?php echo !empty(trim($patient['insurance_validity'] ?? '')) ? $this->customlib->YYYYMMDDTodateFormat(trim($patient['insurance_validity'])) : "-"; ?></span>
                        </li>
                        <li>
                            <b><?php echo $this->lang->line('national_identification_number') ?> </b>
                            <span><?php echo !empty(trim($patient['identification_number'] ?? '')) ? trim($patient['identification_number']) : "-"; ?></span>
                        </li>
                    </ul>
                ...
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <div class="pull-right">
                        ...
                        if ($patient['patient_image']) {
                            ...
                            curl_setopt($client, CURLOPT_POSTFIELDS, json_encode(['value' => $patient['patient_image']]));
                        ...
                        ?>
                        <img class="profile-user-img img-responsive" src="<?= $logo_image ?>" id="image"
            ...
            <div class="row">
                ...
                <div class="col-sm-2 col-xs-4">
                    <div class="form-group">
                        ...
                        <input name="temperature" type="text" value="<?php echo $patient['temperature']; ?>"
                ...
                <div class="col-sm-2 col-xs-4">
                    <div class="form-group">
                        ...
                        <input name="respiration" type="text" value="<?php echo $patient['respiration']; ?>"
                            class="form-control" onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div><select name='symptoms_type' id="act" class="form-control select2 act" style="width:100%">
                                ...
                                <option value="<?php echo $dvalue["id"]; ?>"
                                    <?php echo  set_select('symptoms_type', $dvalue["id"], ($patient['symptoms_type'] == $dvalue["id"]) ? TRUE : FALSE); ?>>
                ...
                <div class="col-sm-6 col-xs-4">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="move_ipd_symptoms"
                            name="symptoms"><?php echo $patient['symptoms']; ?></textarea>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <?php
                        $timestamp = strtotime($patient['appointment_date']);
                        $onlyDate = date("d/m/Y", $timestamp);
                        ?>
                        <input id="admission_date" name="appointment_date" placeholder="" type="text"
                            class="form-control datetime" value="<?php echo $onlyDate ?>" onload="this.value = this.value.split(' ')[0];"
                            onfocus="this.value = this.value.split(' ')[0];" disabled />
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div><input class="form-control" type='text' name='case'
                                value="<?php echo $patient['case_type']; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select name="casualty" id="casualty" class="form-control">
                                ...
                                <option value="Yes" <?php echo ($patient['casualty'] == "Yes") ? "selected" : "" ?>>
                                    <?php echo $this->lang->line('yes') ?></option>
                                <option value="No" <?php echo ($patient['casualty'] == "No") ? "selected" : "" ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div><select class="form-control" name='organisation' id='organisation'>
                                ...
                                <option value="<?php echo $orgvalue["id"]; ?>"
                                    <?php echo set_select('organisation', $orgvalue["id"], ($patient['organisation_id'] == $orgvalue["id"]) ? true : false); ?>>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div><input class="form-control" type='text' name='refference'
                                value="<?php echo $patient['refference']; ?>"
                                onkeyup="this.value=this.value.replace(/[^a-zA-Z]/g,'')" />
                        </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div>
                            <select class="form-control select2" style="width: 100%" id='consultant_doctor'
                                name='consultant_doctor'>
                                <option value=""><?php echo $this->lang->line('select'); ?></option>
                                <?php foreach ($doctors as $dkey => $dvalue) {
                                ?>
                                <option value="<?php echo $dvalue["id"]; ?>"
                                    <?php echo set_select('consultant_doctor', $dvalue["id"], ($patient['cons_doctor'] == $dvalue["id"]) ? true : false); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select name="live_consult" id="live_consult" class="form-control">
                                <option value="yes" <?php echo ($patient['live_consult'] == "yes") ? "selected" : "" ?>>
                                    <?php echo $this->lang->line('yes') ?></option>
                                <option value="no" <?php echo ($patient['live_consult'] == "no") ? "selected" : "" ?>>
                                    <?php echo $this->lang->line('no') ?></option>
