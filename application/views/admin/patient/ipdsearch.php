                            ...
                            <table class="table table-striped table-bordered table-hover" id="ajaxlist">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-center"><?php echo $this->lang->line('ipd_no'); ?></th>
                                        <th class="text-center"><?php echo $this->lang->line('appointment_no'); ?></th>
                                        ...
                                        <th class="text-center"><?php echo $this->lang->line('bed'); ?></th>
                                        <th class="text-right">
                        ...
                        <div class="row row-eq">
                                ...
                                <div class="row ptt10" id="patientDetails" style="display:none">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        ...
                                        <ul class="singlelist">
                                            ...
                                            <li>
                                                <i class="fas fa-user-secret" data-toggle="tooltip" data-placement="top"
                                        ...
                                        <ul class="multilinelist">
                                            <li>
                                                <i class="fas fa-venus-mars" data-toggle="tooltip" data-placement="top"
                                        ...
                                        <ul class="singlelist">
                                            ...
                                            <li>
                                                <i class="fa fa-phone-square" data-toggle="tooltip" data-placement="top"
                                            ...
                                            <li>
                                                <i class="fas fa-street-view" data-toggle="tooltip" data-placement="top"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 col-xs-4">
                                        <div class="form-group">
                                            ...
                                            <div><select name='symptoms_type' id="act" class="form-control select2 act"
                                                    style="width:100%">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-eq ptt10">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('admission_date'); ?></label><small
                                                class="req"> *</small>
                                            <input id="admission_date" name="appointment_date" type="text"
                                                class="form-control datetime" value="<?= date('d/m/Y') ?>" disabled />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select name="casualty" id="casualty" class="form-control">
                                                    ...
                                                    <option selected="" value="<?php echo $this->lang->line('no') ?>">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="exampleInputFile">
                                                <?php echo $this->lang->line('credit_limit') . " (" . $currency_symbol . ")"; ?><small
                                                    class="req"> *</small></label>
                                            <div><input class="form-control" type='text' name='credit_limit'
                                                    value="<?php echo $setting[0]['credit_limit']; ?>" />
                                                <span
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select class="form-control" name='bed_group_id' id="bed_group"
                                                    onchange="getBed(this.value)">
                                                    <option value=""><?php echo $this->lang->line('select') ?></option>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="exampleInputFile">
                                                <?php echo $this->lang->line('bed_number'); ?></label><small
                                                class="req"> *</small>
                                            <div>
                                                <select class="form-control select2" style="width: 100%" name='bed_no'
                                                    id='bed_no'>
                                                    <option value=""><?php echo $this->lang->line('select') ?></option>
                                                </select>
                                                <div class="input-group-append">
                                                    <button type="button" id="addBedBtn" class="btn btn-primary"
                                                        style="display:none;">
...
<div class="modal fade" id="appointmentdetials" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                    ...
                    <table class="table table-bordered table-striped">
                        <tbody>
                            <tr>
                                ...
                                <td colspan="5"><a id="opd_id_appointent" href="#" target="_blank"></a></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><span id='tax_appointment'></span></td>
            ...
            <form id="addbed" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="modal-header modal-media-header">
                    <button type="button" class="close" data-toggle="tooltip"
                        data-original-title="<?php echo $this->lang->line('close'); ?>"
                        data-dismiss="modal">&times;</button>
                    <?php echo $this->lang->line('add') . ' ' . $this->lang->line('bed'); ?></h4>
                </div>
                <div class="modal-body pt0 pb0">
                    <div class="row" id="edit_bedtypedata">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="bed_name" type="text" class="form-control"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label><?php echo $this->lang->line('bed_type'); ?><span class="req"> *</span></label>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label><?php echo $this->lang->line('bed_group'); ?><span class="req"> *</span></label>
                ...
                <div class="modal-footer">
                    <button type="submit" id="addbedbtn" class="btn btn-info"
                        data-loading-text="<?php echo $this->lang->line('processing'); ?>">
...
$(document).ready(function() {
    $("#formadd").on('submit', function(e) {
        ...
        var errormessage = [];
        if (!formData.get("patient_id")) errormessage.push("Please select a patient");
        if (!formData.get("consultant_doctor")) errormessage.push("Please select a consultant doctor");
        if (!parseInt(formData.get("bed_group_id"))) errormessage.push("Please select a bed Number");
        ...
        var mappedData = {
            ...
            "bed": parseInt(formData.get("bed_no")) || "",
            "bed_group_id": parseInt(formData.get("bed_group_id")) || "",
            "case_type": formData.get("case") || "",
            "casualty": formData.get("casualty") ? formData.get("casualty").toLowerCase() : "",
            "symptoms": formData.get("symptoms") || "",
            "known_allergies": "",
            "patient_old": formData.get("old_patient") ? formData.get("old_patient").toLowerCase() :
                "",
            "note": formData.get("note") || "",
            "refference": formData.get("refference") || "",
            "cons_doctor": formData.get("consultant_doctor") ? parseInt(formData.get(
                "consultant_doctor")) : "",
        ...
        if (formData.get("organisation") != 0) {
            mappedData["organisation"] = parseInt(formData.get("organisation")) || "";
        }

         sendAjaxRequest('<?= $api_base_url ?>ipd-main-module/appointmentIPD', "POST", mappedData,
            function(response) {                
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res) {
                    ...
                    $("#national_identification_number").html(res.ABHA_number);
...
function getBed(bed_group, bed = '') {
    ...
    $.ajax({
        ...
        success: function(res) {
            if (res.length === 0) {
                $('#bed_no').html(
                    "<option value=''><?php echo $this->lang->line('no_data_found'); ?></option>");
                $('#addBedBtn').show();
            } else {
                $.each(res, function(i, obj) {
                    var sel = (bed != '' && bed == obj.id) ? "selected" : "";
...
$(document).ready(function() {
    $('#addbed').on('submit', function(e) {
        ...
        if (errorMessages.length > 0) {
         ...
         sendAjaxRequest(
                    `<?= $api_base_url ?>setup-bed-bed`,
                    'POST',
                    formData,
                    function(response) {
                        handleResponse(response,false,'printAppointment',false);
                        const bedGroupId = response[0]["data "].inserted_data[0].bed_group_id;
                        $('#bed_group').val(bedGroupId);                
                        getBed(bedGroupId);
                    }
                );
    });
...
<script>
const initialData = <?= json_encode($ipdlist['data']) ?>;
const totalRecords = <?= $ipdlist['recordsFiltered'] ?>;
let Prefix = '<?=$this->customlib->getSessionPrefixByType('appointment')?>';
$(document).ready(function() {

      initSummaryDataTable(
        `${baseurl}admin/patient/getipdpatientlist`,
        '',
        '#ajaxlist',
        '',
        'renderSummaryTable',
...
function renderSummaryTable(dataArray) {
    ...
    return (dataArray || []).map(item => {
        ...
        const profileUrl = `${baseurl}admin/patient/ipdprofile/${item.id}`;
        const actionBtn = `
            <div class='rowoptionview rowview-mt-19'>
                <a href="${profileUrl}" class='btn btn-default btn-xs' data-toggle='tooltip' title='Show'>
                    <i class='fa fa-reorder' aria-hidden='true'></i>
                </a>
            </div>
        `;
        const ipdLink = `<a href="${profileUrl}">${ipd_id}</a> ${actionBtn}`;
        const appointmentLink =
            `<a href="javascript:void(0);" onclick="viewDetail(${appointment_id})">${Prefix}${appointment_id}</a> ${actionBtn}`;
        const caseId = item.Case_ID || "-";
        const patient = item.patientName || "-";
        const gender = item.gender || "-";
        const mobile = item.mobileno || "-";
        const staff = item.staffname || "-";
        const bed = item.Bed_name || "-";
        const credit = item.credit_limit;
