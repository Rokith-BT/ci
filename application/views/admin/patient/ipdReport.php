                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="search_type" onchange="showdate(this.value)">
                                        <option value="" disable><?php echo $this->lang->line('select'); ?></option>
...
<script type="text/javascript">
    $("#from_age").change(function() {
        var dosage_opt = "<option value='' selected>All</option>";
...
<script>
    $(document).ready(function() {
        ...
        var dataTable = initSummaryDataTable(`${baseurl}/admin/Patient/getipdreport`, '#form1',
            '#ajaxlist');
    ...
    function renderSummaryTable (dataArray) {
        let count = 0;
        let ipd_prefix = '<?php echo $this->customlib->getSessionPrefixByType("ipd_no"); ?>';
        return (dataArray || []).map(function(row) {
            let ipd_id = row.id ?
                `<span onclick="window.location.href='${baseurl}admin/patient/ipdprofile/${row.id}'" style="cursor:pointer; color:#0084B4;">${ipd_prefix + row.id}</span>` :
                '-';
            return [
                ++count,
                ipd_id,
