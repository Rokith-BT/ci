            ...
            <div class="col-md-12">
                <div class="pprinta4">                    
                    <?php if (!empty($print_details['print_header'])) { ?>
                        <?php
                            ...
                            $child_pic = $print_details['print_header'];
                            ...
                            if ($child_pic && $child_pic !== $picdemo) {
                                ...
                                if ($response !== false && !empty($response)) {
                                    ...
                                    $base64Image = "data:image/png;base64," . base64_encode(file_get_contents($picdemo));
                                }
                            } else {
                                $base64Image = "data:image/png;base64," . base64_encode(file_get_contents($picdemo));
                            }
                            ?>
                         <img src="<?=$base64Image?>" style="height:100px; width:100%;" class="img-responsive">
                    <?php } ?>
                ...
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        ...
                        <tr>
                        <th width="10%">SPO2</th>
                        <td width="10%"><?php echo $result["spo2"] ?></td>
